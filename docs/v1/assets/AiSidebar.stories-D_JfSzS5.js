import{x as d}from"./iframe-CsFrBjI9.js";import{I as p,c,d as l,e as f,f as g,g as m,h,i as u}from"./icon-registry-Bd3qIBK6.js";import{d as y,a as b}from"./ai-sidebar-DMfYJ3A4.js";import"./ai-chat-interface-Cl3q3LaV.js";import"./ai-prompt-ZZUxzQXN.js";import"./ai-chat-header-CkP3cc2V.js";import"./ai-user-message-BnSlaBUN.js";import"./ai-response-message-9oDjj61j.js";import"./ai-button-Ct9IDzSe.js";import{d as I}from"./index-X7RLalui.js";const{action:r}=__STORYBOOK_MODULE_ACTIONS__;y();b();I();p.define([c,l,f,g,m,h,u]);const w="forge-ai-sidebar",x={title:"AI Components/Primitives/Sidebar",component:w,argTypes:{open:{control:{type:"boolean"},description:"Controls whether the sidebar is open"},expanded:{control:{type:"boolean"},description:"Controls whether the sidebar is displayed in an expanded state"}},args:{open:!1,expanded:!1},render:a=>{const t=r("forge-ai-sidebar-open"),i=r("forge-ai-sidebar-close"),s=()=>{const e=document.querySelector("forge-ai-chat-interface");e&&(e.expanded=!e.expanded)},n=()=>{document.querySelector("forge-ai-sidebar")?.close()};return d`
