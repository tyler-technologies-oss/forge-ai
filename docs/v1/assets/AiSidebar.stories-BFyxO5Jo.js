import{x as d}from"./iframe-lCzSBZJV.js";import{I as p,c,d as l,e as f,f as g,g as m,h,i as u}from"./icon-registry-Bd3qIBK6.js";import{d as y,a as b}from"./ai-sidebar-BXhajapq.js";import"./ai-chat-interface-D0ljhRPA.js";import"./ai-prompt-DdVL7tlX.js";import"./ai-chat-header-CWPz654e.js";import"./ai-user-message-CkustoM5.js";import"./ai-response-message-CWIRDCyo.js";import"./ai-button-Be55mlsO.js";import{d as I}from"./index-B3twr5GA.js";const{action:r}=__STORYBOOK_MODULE_ACTIONS__;y();b();I();p.define([c,l,f,g,m,h,u]);const w="forge-ai-sidebar",x={title:"AI Components/Primitives/Sidebar",component:w,argTypes:{open:{control:{type:"boolean"},description:"Controls whether the sidebar is open"},expanded:{control:{type:"boolean"},description:"Controls whether the sidebar is displayed in an expanded state"}},args:{open:!1,expanded:!1},render:a=>{const t=r("forge-ai-sidebar-open"),i=r("forge-ai-sidebar-close"),s=()=>{const e=document.querySelector("forge-ai-chat-interface");e&&(e.expanded=!e.expanded)},n=()=>{document.querySelector("forge-ai-sidebar")?.close()};return d`
