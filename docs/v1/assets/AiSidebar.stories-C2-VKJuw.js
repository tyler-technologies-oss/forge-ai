import{x as d}from"./iframe-CSaZy7F4.js";import{I as p,g as c,h as l,i as f,j as g,k as m,l as h,m as u}from"./icon-registry-R_jHqdiQ.js";import{d as y,a as b}from"./ai-sidebar-DMyssIom.js";import"./ai-chat-interface-DQFdGdei.js";import"./ai-prompt-CDdP_VJe.js";import"./ai-chat-header-DFlqhRo_.js";import"./ai-user-message-DwVEOwI6.js";import"./ai-response-message-DwBgeB-y.js";import"./ai-button-rwYCvRKj.js";import{d as I}from"./index-BoTl3oLY.js";const{action:r}=__STORYBOOK_MODULE_ACTIONS__;y();b();I();p.define([c,l,f,g,m,h,u]);const w="forge-ai-sidebar",x={title:"AI Components/Primitives/Sidebar",component:w,argTypes:{open:{control:{type:"boolean"},description:"Controls whether the sidebar is open"},expanded:{control:{type:"boolean"},description:"Controls whether the sidebar is displayed in an expanded state"}},args:{open:!1,expanded:!1},render:a=>{const t=r("forge-ai-sidebar-open"),i=r("forge-ai-sidebar-close"),s=()=>{const e=document.querySelector("forge-ai-chat-interface");e&&(e.expanded=!e.expanded)},n=()=>{document.querySelector("forge-ai-sidebar")?.close()};return d`
