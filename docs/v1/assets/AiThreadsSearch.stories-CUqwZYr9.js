import{x as u}from"./iframe-CoCnQeKl.js";import"./ai-threads-search-BFGeHI6I.js";import"./ai-threads-7xjstlmC.js";import"./preload-helper-PPVm8Dsz.js";import"./custom-element-UsVr97OX.js";import"./property-CpZynkB1.js";import"./query-D9Yvha-e.js";import"./class-map-BResTQ8y.js";import"./when-CI7b_ccM.js";import"./utils-DIqd7FWX.js";import"./ai-edit-thread-mHLyy37Q.js";import"./ref-CNEf0xZH.js";import"./ai-dropdown-menu-BMRjtL2u.js";import"./query-assigned-elements-DTZxeBhO.js";import"./if-defined-ijNNdxnk.js";import"./popover-33RnhOwL.js";import"./overlay-CqQDtub0.js";import"./floating-ui.dom-CHtvoTQ1.js";import"./query-assigned-nodes-C3XBAQFI.js";import"./ai-dropdown-menu-item-Cqam3LOA.js";import"./ai-error-message-CaApnihJ.js";import"./ai-spinner-C9JM70TX.js";import"./ai-modal-CxjbusBW.js";import"./ai-icon-CQuyPM2r.js";import"./ai-gradient-container-Ci69sNtA.js";const{action:r}=__STORYBOOK_MODULE_ACTIONS__,s=(e,t=0)=>{const a=["Getting Started with AI","Data Analysis Question","Code Review Discussion","Project Planning","Bug Investigation","Feature Development"];return Array.from({length:e},(o,n)=>({id:`thread-${t+n+1}`,title:`${a[n%a.length]}`,createdAt:new Date(Date.now()-(n+t)*864e5).toISOString(),messageCount:Math.floor(Math.random()*20)+1}))},D="forge-ai-threads-search",te={title:"AI Components/Primitives/Threads Search",component:D,argTypes:{threads:{control:"object",description:"Array of threads to display"},totalChats:{control:{type:"number"},description:"Total number of chats available for pagination. Set to 0 to disable infinite scroll."},headerTitle:{control:"text",description:"Title text shown in the header"},showNewChatButton:{control:"boolean",description:'Show "New chat" button in header'},showBackButton:{control:"boolean",description:"Show a back button before the header title"},showSearch:{control:"boolean",description:"Show the search field"},showThreadRename:{control:"boolean",description:"Show rename action in thread menu"},showThreadDelete:{control:"boolean",description:"Show delete action in thread menu"},placeholder:{control:"text",description:"Placeholder text for search input"},errorMessage:{control:"text",description:"Message describing a failed thread load. Replaces the empty state with a retry banner when nothing is loaded. When threads are already on screen the list stays visible and the message shows as a compact single line with a retry - at the bottom of the list if a page was in flight, otherwise above it"}},args:{threads:s(10),totalChats:0,headerTitle:"All chats",showNewChatButton:!0,showBackButton:!1,showSearch:!0,placeholder:"Search conversations..."},render:e=>u`
