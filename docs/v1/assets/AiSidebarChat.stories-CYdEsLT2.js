import{r as D,i as M,x as d}from"./iframe-lCzSBZJV.js";import{I as P,c as R,d as z,e as B,f as W,g as H,h as L,i as V}from"./icon-registry-Bd3qIBK6.js";import{t as j}from"./custom-element-C028faeO.js";import{n as k}from"./property-Fh8vuuB6.js";import{n as C,e as w}from"./ai-modal-CtX-saxy.js";import{n as q}from"./when-3fO0zp9C.js";import{d as F,a as G}from"./ai-sidebar-BXhajapq.js";import"./ai-chat-interface-D0ljhRPA.js";import"./ai-chat-header-CWPz654e.js";import"./ai-user-message-CkustoM5.js";import"./ai-response-message-CWIRDCyo.js";import"./ai-suggestions-vMi2Hoee.js";import"./ai-button-Be55mlsO.js";import"./ai-prompt-DdVL7tlX.js";import{d as K}from"./index-B3twr5GA.js";import{_ as U,c as X,e as Y,d as J}from"./tslib.es6-B3DjoPPp.js";import{C as Q,d as Z,b as ee}from"./constants-gdUIRxM-.js";/**
 * @license
 ...
 * Copyright Tyler Technologies, Inc. 
 * License: Apache-2.0
 */function se(){J(v)}const ie=":host{display:block;height:100%}";var ne=Object.defineProperty,de=Object.getOwnPropertyDescriptor,I=t=>{throw TypeError(t)},x=(t,e,a,n)=>{for(var i=n>1?void 0:n?de(e,a):e,l=t.length-1,c;l>=0;l--)(c=t[l])&&(i=(n?c(e,a,i):c(i))||i);return n&&i&&ne(e,a,i),i},A=(t,e,a)=>e.has(t)||I("Cannot "+a),b=(t,e,a)=>(A(t,e,"read from private field"),a?a.call(t):e.get(t)),m=(t,e,a)=>e.has(t)?I("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,a),r=(t,e,a)=>(A(t,e,"access private method"),a),u,_,o,y,S,E,O,T,N,s;const le="forge-ai-sidebar-chat";let p=class extends M{constructor(){super(...arguments),m(this,o),this.open=!1,this.expanded=!1,m(this,u,w()),m(this,_,w())}render(){return d`
      ${q(this.expanded,()=>d`
          <forge-ai-modal
            ${C(b(this,_))}
    ...
    `}},h={};h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:"{}",...h.parameters?.docs?.source}}};const ce=["Demo"],Te=Object.freeze(Object.defineProperty({__proto__:null,Demo:h,__namedExportsOrder:ce,default:pe},Symbol.toStringTag,{value:"Module"}));export{Te as A};
