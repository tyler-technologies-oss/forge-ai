import{x as n}from"./iframe-DUFfrjrK.js";import"./ai-chatbot-launcher-6aj0P8KJ.js";import{M as r}from"./mock-adapter-B6avymXj.js";import{s as T}from"./utils-C9ohEeal.js";import{I as y,t as S,a as I}from"./scaffold-LOM6ekoX.js";import"./split-button-Bz4GmGbS.js";import{d as D}from"./index-D6jXVCu6.js";import{d as R}from"./index-DVsXnHq4.js";const{action:t}=__STORYBOOK_MODULE_ACTIONS__,A="forge-ai-chatbot-launcher",C={title:"AI Components/Form Factors/Launcher",component:A,argTypes:{placeholder:{control:"text",description:"Placeholder text for the input field"},titleText:{control:"text",description:"Title text displayed in the welcome view"},descriptionText:{control:"text",description:"Description text displayed below the title"},fileUpload:{control:"select",options:["on","off"],description:"Enable file upload functionality"},voiceInput:{control:"select",options:["on","off"],description:"Enable voice input functionality"},exportOption:{control:"select",options:["on","off"],description:"Control export option visibility"},enableReactions:{control:"boolean",description:"Enable thumbs up/down reaction buttons"},disclaimerText:{control:"text",description:"Disclaimer text displayed below the prompt"},threadName:{control:"text",description:"Thread name displayed in conversation view breadcrumb"},showThreadRename:{control:"boolean",description:"Show rename option in thread actions menu"},showThreadDelete:{control:"boolean",description:"Show delete option in thread actions menu"}},args:{placeholder:"How can I help you today?",titleText:"AI Assistant",descriptionText:"",fileUpload:"on",voiceInput:"on",exportOption:"on",enableReactions:!1,disclaimerText:"AI can make mistakes. Always verify responses."},render:e=>{const a=new r({simulateStreaming:!0,simulateTools:!1,streamingDelay:50,responseDelay:500}),u=t("forge-ai-chatbot-launcher-connected"),m=t("forge-ai-chatbot-launcher-message-sent"),f=t("forge-ai-chatbot-launcher-message-received"),o=t("forge-ai-chatbot-launcher-tool-call"),i=t("forge-ai-chatbot-launcher-error"),b=t("forge-ai-chatbot-launcher-conversation-start"),x=t("forge-ai-chatbot-launcher-clear"),v=t("forge-ai-chatbot-launcher-response-feedback"),$=t("forge-ai-chatbot-launcher-info"),w=t("forge-ai-chatbot-launcher-agent-change");return n`
      <div
        ...
        <forge-ai-chatbot-launcher
          ...
          @forge-ai-chatbot-launcher-connected=${u}
    ...
    `}},s={},c={args:{threadName:"Discussion about project requirements and timeline",showThreadRename:!0,showThreadDelete:!0},render:e=>{const a=new r({simulateStreaming:!0,simulateTools:!1,streamingDelay:50,responseDelay:500}),u=t("forge-ai-chatbot-launcher-thread-rename"),m=t("forge-ai-chatbot-launcher-thread-delete");return n`
      <div
        style="width: 100%; height: 600px; max-width: 900px; margin: 0 auto; border: 1px solid #e0e0e0; border-radius: 8px; overflow: hidden;">
        <forge-ai-chatbot-launcher
          .adapter=${a}
          ...
          @forge-ai-chatbot-launcher-thread-rename=${o=>{u(o.detail);const i=o.target;i.threadName=o.detail.newTitle,setTimeout(()=>{t("onSuccess")("Rename succeeded"),o.detail.onSuccess()},500)}}
    ...
    `}},p={render:e=>{R(),D(),y.define([S,I]);const a=new r({simulateStreaming:!0,simulateTools:!1,streamingDelay:50,responseDelay:500});return n`
      <div
        style="width: 100%; height: 600px; max-width: 900px; margin: 0 auto; border: 1px solid #e0e0e0; border-radius: 8px; overflow: hidden;">
        <forge-ai-chatbot-launcher
          .adapter=${a}
...
}`,...p.parameters?.docs?.source}}};const k=["Demo","WithThreadName","WithSuggestions","FullPage","WithCustomHeader","WithHeaderActions"],F=Object.freeze(Object.defineProperty({__proto__:null,Demo:s,FullPage:d,WithCustomHeader:h,WithHeaderActions:p,WithSuggestions:l,WithThreadName:c,__namedExportsOrder:k,default:C},Symbol.toStringTag,{value:"Module"}));export{F as A};
