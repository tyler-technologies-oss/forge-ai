import{r as A,x as l,E as x}from"./iframe-8UPTGfWp.js";import{t as L}from"./custom-element-UsVr97OX.js";import{n as m}from"./property-B2GkyXrM.js";import{e as h,n as f}from"./ref-lHttI-ZF.js";import{n as u}from"./when-CI7b_ccM.js";import{A as R}from"./ai-chatbot-base-C_pyZPQ4.js";import"./ai-attachment-Dewq3KNG.js";import"./ai-chat-header-CJwtGDbD.js";import"./ai-chat-interface-CTPn9lAK.js";import"./ai-file-picker-X2KjCa9t.js";import"./ai-message-thread-C1xAPReg.js";import"./ai-prompt-1VZNsTyH.js";import"./ai-spinner-0vRu4QNY.js";import"./ai-suggestions-BoT21NDX.js";import"./ai-voice-input-rcNaCwBr.js";const T=':host{display:block;width:100%;height:100%;--_ai-chatbot-icon-shape: var(--forge-ai-chatbot-icon-shape, calc(var(--forge-shape-round, 50%) * var(--forge-shape-factor, 1)))}forge-ai-chat-interface::part(messages){overflow:hidden}forge-ai-chat-interface forge-ai-message-thread{min-height:0}.session-files{display:flex;flex-direction:column;gap:var(--forge-spacing-xsmall, 8px);min-width:0}.session-files .session-files-header{-moz-osx-font-smoothing:grayscale;-webkit-font-smoothing:antialiased;font-family:var(--forge-typography-label1-font-family, var(--forge-typography-font-family, "Roboto", sans-serif));font-size:var(--forge-typography-label1-font-size, calc(var(--forge-typography-font-size, 1rem) * var(--forge-typography-label-font-size-scale, .75)));font-weight:var(--forge-typography-label1-font-weight, 400);line-height:var(--forge-typography-label1-line-height, calc(var(--forge-typography-font-size, 1rem) * var(--forge-typography-label-line-height-scale, 1.25)));letter-spacing:var(--forge-typography-label1-letter-spacing, .0357142857em);text-transform:var(--forge-typography-label1-text-transform, inherit);text-decoration:var(--forge-typography-label1-text-decoration, inherit);color:var(--forge-theme-text-medium, rgba(0, 0, 0, .6))}.session-files .session-files-list::-webkit-scrollbar{height:var(--forge-scrollbar-height, 16px);width:var(--forge-scrollbar-width, 16px)}.session-files .session-files-list::-webkit-scrollbar-track{background-color:var(--forge-scrollbar-track-container, var(--forge-theme-surface-container-low, #ebebeb))}.session-files .session-files-list::-webkit-scrollbar-track:hover{background-color:var(--forge-scrollbar-track-container-hover, var(--forge-theme-surface-container-low, #ebebeb))}.session-files .session-files-list::-webkit-scrollbar-corner{background-color:var(--forge-scrollbar-track-container, var(--forge-theme-surface-container-low, #ebebeb))}.session-files .session-files-list::-webkit-scrollbar-thumb{height:var(--forge-scrollbar-thumb-min-height, 32px);width:var(--forge-scrollbar-thumb-min-width, 32px);border-radius:var(--forge-scrollbar-border-radius, calc(var(--forge-shape-full, 9999px) * var(--forge-shape-factor, 1)));border-width:var(--forge-scrollbar-border-width, 3px);border-style:solid;border-color:transparent;background-color:var(--forge-scrollbar-thumb-container, var(--forge-theme-surface-container-medium, #c2c2c2));background-clip:content-box}.session-files .session-files-list::-webkit-scrollbar-thumb:hover{background-color:var(--forge-scrollbar-thumb-container-hover, var(--forge-theme-surface-container-high, #9e9e9e))}.session-files .session-files-list{display:flex;gap:var(--forge-spacing-small, 12px);overflow-x:auto;padding-block-end:var(--forge-spacing-xsmall, 8px)}.disclaimer{-moz-osx-font-smoothing:grayscale;-webkit-font-smoothing:antialiased;font-family:var(--forge-typography-label1-font-family, var(--forge-typography-font-family, "Roboto", sans-serif));font-size:var(--forge-typography-label1-font-size, calc(var(--forge-typography-font-size, 1rem) * var(--forge-typography-label-font-size-scale, .75)));font-weight:var(--forge-typography-label1-font-weight, 400);line-height:var(--forge-typography-label1-line-height, calc(var(--forge-typography-font-size, 1rem) * var(--forge-typography-label-line-height-scale, 1.25)));letter-spacing:var(--forge-typography-label1-letter-spacing, .0357142857em);text-transform:var(--forge-typography-label1-text-transform, inherit);text-decoration:var(--forge-typography-label1-text-decoration, inherit);color:var(--forge-theme-text-medium, rgba(0, 0, 0, .6));text-align:center;margin-block-start:var(--forge-spacing-xxsmall, 4px);margin-block-end:calc(var(--forge-spacing-small, 12px) * -1)}.suggestions-container{width:100%;align-self:start}.empty-state-icon,::slotted([slot=empty-state-icon]){height:200px;width:200px;border-radius:var(--_ai-chatbot-icon-shape)}';var E=Object.defineProperty,B=Object.getOwnPropertyDescriptor,_=s=>{throw TypeError(s)},r=(s,e,a,n)=>{for(var o=n>1?void 0:n?B(e,a):e,y=s.length-1,b;y>=0;y--)(b=s[y])&&(o=(n?b(e,a,o):b(o))||o);return n&&o&&E(e,a,o),o},$=(s,e,a)=>e.has(s)||_("Cannot "+a),c=(s,e,a)=>($(s,e,"read from private field"),a?a.call(s):e.get(s)),p=(s,e,a)=>e.has(s)?_("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(s):e.set(s,a),d=(s,e,a)=>($(s,e,"access private method"),a),v,g,t,w,S,k,z,Z,C,I,M;const U="forge-ai-chatbot";let i=class extends R{constructor(){super(...arguments),p(this,t),this.showExpandButton=!1,this.showMinimizeButton=!1,this.expanded=!1,this.minimizeIcon="default",p(this,v,h()),this._messageThreadRef=h(),this._promptRef=h(),p(this,g,h()),p(this,M,l`
  ...
  `)}_handleInfo(){const s=c(this,g).value;s?.showAgentInfo&&s.showAgentInfo(),super._handleInfo()}async sendMessage(s,e){this._promptRef.value?.closeSlashMenu(),await super.sendMessage(s,e)}focus(){this._promptRef.value?.focus()}render(){return l`
      <forge-ai-chat-interface
        ...
        <forge-ai-chat-header
          ...
          @forge-ai-chat-header-expand=${d(this,t,w)}
          @forge-ai-chat-header-minimize=${d(this,t,S)}
          @forge-ai-chat-header-clear=${d(this,t,k)}
          @forge-ai-chat-header-export=${this._handleExport}
          @forge-ai-chat-header-info=${d(this,t,z)}
        ...
        ${c(this,t,Z)} ${c(this,t,I)} ${c(this,t,C)}
        ${u(this.disclaimerText,()=>l`<div class="disclaimer" slot="disclaimer">${this.disclaimerText}</div>`)}
      </forge-ai-chat-interface>
    `}};v=new WeakMap;g=new WeakMap;t=new WeakSet;w=function(){this._dispatchHostEvent({type:"forge-ai-chatbot-expand"})};S=function(){this._dispatchHostEvent({type:"forge-ai-chatbot-minimize"})};k=function(){this.clearMessages()};z=function(){this._handleInfo()};Z=function(){const s=this._sessionFilesTemplate;return s===x?x:l`<div class="session-files" slot="attachments">${s}</div>`};C=function(){const s=this._isUploading;return l`
      <forge-ai-prompt
        ${f(this._promptRef)}
        slot="prompt"
        .placeholder=${this.placeholder}
        .running=${this._isStreaming||s}
    ...
    `};I=function(){return l`
      <forge-ai-message-thread
        ...
        <slot name="empty-state-icon" slot="empty-state-icon">${c(this,M)}</slot>
    ...
    `};M=new WeakMap;i.styles=A(T);r([m({type:Boolean,attribute:"show-expand-button"})],i.prototype,"showExpandButton",2);r([m({type:Boolean,attribute:"show-minimize-button"})],i.prototype,"showMinimizeButton",2);r([m({type:Boolean})],i.prototype,"expanded",2);r([m({attribute:"minimize-icon"})],i.prototype,"minimizeIcon",2);i=r([L(U)],i);
