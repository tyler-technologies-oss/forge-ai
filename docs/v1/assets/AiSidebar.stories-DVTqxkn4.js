import{x as d}from"./iframe-DFsyteUX.js";import{I as p,j as c,k as l,l as f,m,n as g,o as h,p as u}from"./split-button-Dz5D8SDw.js";import{d as y,a as b}from"./ai-sidebar-DU0iNUMF.js";import{d as I}from"./index-CzTroNpj.js";import"./ai-chat-interface-CjEDFaf2.js";import"./ai-prompt-Do4anHZo.js";import"./ai-chat-header-C5TLUmbq.js";import"./ai-user-message-392l8dTp.js";import"./ai-response-message-CeUpwxCg.js";import"./ai-button-ClU53cwN.js";const{action:r}=__STORYBOOK_MODULE_ACTIONS__;y();b();I();p.define([c,l,f,m,g,h,u]);const w="forge-ai-sidebar",x={title:"AI Components/Primitives/Sidebar",component:w,argTypes:{open:{control:{type:"boolean"},description:"Controls whether the sidebar is open"},expanded:{control:{type:"boolean"},description:"Controls whether the sidebar is displayed in an expanded state"}},args:{open:!1,expanded:!1},render:a=>{const t=r("forge-ai-sidebar-open"),i=r("forge-ai-sidebar-close"),s=()=>{const e=document.querySelector("forge-ai-chat-interface");e&&(e.expanded=!e.expanded)},n=()=>{document.querySelector("forge-ai-sidebar")?.close()};return d`
