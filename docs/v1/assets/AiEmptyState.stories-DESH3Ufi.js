import{x as e}from"./iframe-lCzSBZJV.js";import"./ai-empty-state-DQ6gU6lS.js";import"./ai-suggestions-vMi2Hoee.js";const a="forge-ai-empty-state",n={title:"AI Components/Primitives/Empty State",component:a,argTypes:{showSuggestions:{control:"boolean",description:"Show or hide the suggestions"},customMessage:{control:"text",description:"Custom message text (leave empty for default)"},useCustomIcon:{control:"boolean",description:"Use custom icon instead of default books icon"},iconType:{control:{type:"select"},options:["star","robot","lightbulb","heart"],description:"Type of custom icon to show",if:{arg:"useCustomIcon",truthy:!0}}},args:{showSuggestions:!0,customMessage:"",useCustomIcon:!1,iconType:"star"},render:t=>{const o=[{text:"Help me write an email",value:"email"},{text:"Create a presentation",value:"presentation"},{text:"Write some code",value:"code"},{text:"Plan a meeting",value:"meeting"}],c=r=>{switch(r){case"star":return e`
      ...
      <forge-ai-empty-state>
        ...
        ${t.showSuggestions?e`
              <forge-ai-suggestions slot="actions" variant="block" .suggestions=${o}> </forge-ai-suggestions>
            `:""}
      </forge-ai-empty-state>
    `}},s={args:{customMessage:"Welcome to the Tyler Ai!  "}};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  args: {
    customMessage: 'Welcome to the Tyler Ai!  '
  }
}`,...s.parameters?.docs?.source}}};const i=["Demo"],u=Object.freeze(Object.defineProperty({__proto__:null,Demo:s,__namedExportsOrder:i,default:n},Symbol.toStringTag,{value:"Module"}));export{u as A,s as D};
