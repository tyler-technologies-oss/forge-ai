import{x as d}from"./iframe-CupD09ex.js";import{I as c,c as p,d as l,e as f,f as g,g as m,h,i as u}from"./icon-registry-Bd3qIBK6.js";import{d as y,a as b}from"./ai-sidebar-CORyY1i6.js";import"./ai-chat-interface-BELZ5qor.js";import"./ai-chat-header-Cpv6Dy43.js";import"./ai-user-message-ryaaA4ek.js";import"./ai-response-message-zkwZmrJ0.js";import"./ai-button-BOgxo33U.js";import{d as I}from"./index-DProsVgL.js";const{action:r}=__STORYBOOK_MODULE_ACTIONS__;y();b();I();c.define([p,l,f,g,m,h,u]);const w="forge-ai-sidebar",x={title:"AI Components/Primitives/Sidebar",component:w,argTypes:{open:{control:{type:"boolean"},description:"Controls whether the sidebar is open"},expanded:{control:{type:"boolean"},description:"Controls whether the sidebar is displayed in an expanded state"}},args:{open:!1,expanded:!1},render:a=>{const t=r("forge-ai-sidebar-open"),i=r("forge-ai-sidebar-close"),s=()=>{const e=document.querySelector("forge-ai-chat-interface");e&&(e.expanded=!e.expanded)},n=()=>{document.querySelector("forge-ai-sidebar")?.close()};return d`
