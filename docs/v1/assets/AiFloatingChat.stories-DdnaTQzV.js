import{r as F,i as S,x as l}from"./iframe-lCzSBZJV.js";import{t as E}from"./custom-element-C028faeO.js";import{n as y}from"./property-Fh8vuuB6.js";import{r as T}from"./state-DLFYxJ1X.js";import{n as A,e as I}from"./ai-modal-CtX-saxy.js";import"./ai-dialog-Ch73teuU.js";import"./ai-chat-interface-D0ljhRPA.js";import"./ai-chat-header-CWPz654e.js";import"./ai-user-message-CkustoM5.js";import"./ai-response-message-CWIRDCyo.js";import"./ai-fab-CFENeSKM.js";import"./ai-suggestions-vMi2Hoee.js";import"./ai-prompt-DdVL7tlX.js";const H=":host{display:block}";var z=Object.defineProperty,k=Object.getOwnPropertyDescriptor,v=e=>{throw TypeError(e)},d=(e,t,o,r)=>{for(var a=r>1?void 0:r?k(t,o):t,u=e.length-1,m;u>=0;u--)(m=e[u])&&(a=(r?m(t,o,a):m(a))||a);return r&&a&&z(t,o,a),a},w=(e,t,o)=>t.has(e)||v("Cannot "+o),f=(e,t,o)=>(w(e,t,"read from private field"),o?o.call(e):t.get(e)),x=(e,t,o)=>t.has(e)?v("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,o),n=(e,t,o)=>(w(e,t,"access private method"),o),p,s,_,b,$,C,i;const O="forge-ai-floating-chat";let h=class extends S{constructor(){super(...arguments),x(this,s),this.open=!1,this.expanded=!1,this._isFullscreen=!1,x(this,p,I())}updated(){f(this,p).value&&this._isFullscreen!==f(this,p).value.isFullscreen&&(this._isFullscreen=f(this,p).value.isFullscreen)}render(){return l`
      <forge-ai-dialog
        ${A(f(this,p))}
        ?open=${this.open}
