import{x as v}from"./iframe-Dye8ZKA5.js";import"./ai-conversations-panel-Y0U0Aluz.js";import"./preload-helper-PPVm8Dsz.js";import"./custom-element-UsVr97OX.js";import"./property-CSVhZUH2.js";import"./class-map-C-Vm7qAC.js";import"./when-CI7b_ccM.js";import"./ai-edit-thread-DpP_-oS2.js";import"./ref-DTbB5e9O.js";import"./ai-dropdown-menu-CehISYXs.js";import"./query-assigned-nodes-C08U1rRi.js";import"./if-defined-DB6czLUl.js";import"./popover-DXNPGDhS.js";import"./overlay-E_yvTlvY.js";import"./floating-ui.dom-alButkyJ.js";import"./utils-BGBq21po.js";import"./ai-dropdown-menu-item-BsIeXVo7.js";import"./infinite-scroll-controller-5t8GywO2.js";import"./ai-modal-mlSLNT1K.js";import"./ai-icon-DxaiajKT.js";import"./ai-gradient-container-kls7ss2d.js";import"./ai-spinner-ChGg4s1h.js";const{action:e}=__STORYBOOK_MODULE_ACTIONS__,b="forge-ai-conversations-panel",A=(n,a=0)=>{const r=["TypeScript","Web Components","React","Angular","Vue","CSS Grid","Flexbox","JavaScript","Performance","Testing"],t=["best practices","tutorial","comparison","explained","patterns","optimization","debugging"];return Array.from({length:n},(s,i)=>{const o=a+i,l=r[o%r.length],c=t[Math.floor(o/r.length)%t.length],d=Math.floor(o/5)+1,h=Math.floor(Math.random()*20)+1;return{id:`thread-${o+1}`,title:`${l} ${c}`,createdAt:new Date(Date.now()-d*24*60*60*1e3).toISOString(),messageCount:h}})},D=[{id:"thread-1",title:"TypeScript best practices",createdAt:new Date(Date.now()-7200*1e3).toISOString(),messageCount:8},{id:"thread-2",title:"Web component architecture",createdAt:new Date(Date.now()-300*60*1e3).toISOString(),messageCount:15},{id:"thread-3",title:"How to use localStorage?",createdAt:new Date(Date.now()-1440*60*1e3).toISOString(),messageCount:3},{id:"thread-4",title:"Lit reactive controllers explained",createdAt:new Date(Date.now()-2160*60*1e3).toISOString(),messageCount:12},{id:"thread-5",title:"CSS Grid vs Flexbox comparison",createdAt:new Date(Date.now()-2880*60*1e3).toISOString(),messageCount:6},{id:"thread-6",title:"JavaScript async/await patterns",createdAt:new Date(Date.now()-4320*60*1e3).toISOString(),messageCount:9},{id:"thread-7",title:"React hooks vs Lit reactive properties",createdAt:new Date(Date.now()-5760*60*1e3).toISOString(),messageCount:7},{id:"thread-8",title:"Testing web components",createdAt:new Date(Date.now()-7200*60*1e3).toISOString(),messageCount:11}],Y={title:"AI Components/Primitives/Conversations Panel",component:b,argTypes:{recentThreads:{control:"object",description:"Array of recent conversation threads to display"},totalChats:{control:{type:"number"},description:"Total number of chats available for pagination. Set to 0 to disable infinite scroll."},selectedThreadId:{control:"text",description:"ID of the currently selected thread"},showConversationRename:{control:"boolean",description:"Show rename option in conversations panel"},showConversationDelete:{control:"boolean",description:"Show delete option in conversations panel"},loading:{control:"boolean",description:"Show a loading indicator in the recent chats list while threads are loading"}},args:{recentThreads:D,totalChats:0,selectedThreadId:null,showConversationRename:!0,showConversationDelete:!0,loading:!1},render:n=>v`
    ...
    `},m={},u={args:{selectedThreadId:"thread-2"}},f={args:{recentThreads:[]}},w={args:{recentThreads:[],loading:!0}},S={args:{recentThreads:D},render:n=>v`
      <div style="width: 400px; height: 600px; border: 1px solid var(--forge-theme-outline);">
        <forge-ai-conversations-panel
          .recentThreads=${n.recentThreads}
          .selectedThreadId=${n.selectedThreadId}
...
}`,...$.parameters?.docs?.source}}};const Q=["Demo","WithSelectedThread","EmptyState","Loading","WithLocalSearch","WithAsyncSearch","WithNoRecentThreads","WithInfiniteScroll"];export{m as Demo,f as EmptyState,w as Loading,T as WithAsyncSearch,$ as WithInfiniteScroll,S as WithLocalSearch,C as WithNoRecentThreads,u as WithSelectedThread,Q as __namedExportsOrder,Y as default};
