import{r as E,i as M,x as f}from"./iframe-Dye8ZKA5.js";import{t as O}from"./custom-element-UsVr97OX.js";import{n as s}from"./property-CSVhZUH2.js";import{r as T}from"./class-map-C-Vm7qAC.js";import{o as F}from"./if-defined-DB6czLUl.js";import{n as I,e as S}from"./ref-DTbB5e9O.js";import{n as D}from"./when-CI7b_ccM.js";import"./ai-chatbot-base-By36OxwM.js";import"./ai-chatbot-Cxuyhrzr.js";import"./ai-message-thread-D0Qpnw94.js";import"./markdown-CtLA8yAF.js";import"./ai-gradient-container-kls7ss2d.js";import"./ai-modal-mlSLNT1K.js";import{M as U}from"./mock-adapter-ph_xQ6k2.js";const P=":host{display:block}.ai-embedded-chat{display:contents}";var V=Object.defineProperty,z=Object.getOwnPropertyDescriptor,x=e=>{throw TypeError(e)},n=(e,t,a,g)=>{for(var l=g>1?void 0:g?z(t,a):t,u=e.length-1,b;u>=0;u--)(b=e[u])&&(l=(g?b(t,a,l):b(l))||l);return g&&l&&V(t,a,l),l},$=(e,t,a)=>t.has(e)||x("Cannot "+a),c=(e,t,a)=>($(e,t,"read from private field"),a?a.call(e):t.get(e)),v=(e,t,a)=>t.has(e)?x("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,a),d=(e,t,a)=>($(e,t,"access private method"),a),p,o,_,y,C,A,w,m;const k="forge-ai-embedded-chat";let i=class extends M{constructor(){super(...arguments),v(this,o),this.expanded=!1,this.gradientVariant="medium",this.fileUpload="off",this.placeholder="Ask a question...",this.label="AI Assistant",this._isModalFullscreen=!1,v(this,p,S())}updated(){c(this,p).value&&this._isModalFullscreen!==c(this,p).value.fullscreen&&(this._isModalFullscreen=c(this,p).value.fullscreen??!1)}render(){return f`
      ${D(this.expanded,()=>f`
          <forge-ai-modal
            ${I(c(this,p))}
            ?open=${this.expanded}
