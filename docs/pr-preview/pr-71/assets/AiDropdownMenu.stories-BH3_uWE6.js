import{x as a}from"./iframe-BTNck0jc.js";import"./ai-dropdown-menu-VM51zu4b.js";import"./ai-dropdown-menu-item-DZkB3W-W.js";import{I as d,i as p,j as m,k as s}from"./scaffold-Bo7D00de.js";import"./split-button-CrbtY5VN.js";import{d as u}from"./index-CRhMvxrb.js";const{action:l}=__STORYBOOK_MODULE_ACTIONS__;u();d.define([p,m,s]);const g="forge-ai-dropdown-menu",i=l("forge-ai-dropdown-menu-change"),c={title:"AI Components/Primitives/Dropdown Menu",component:g,argTypes:{variant:{control:"select",options:["button","icon-button"],description:"The variant of the dropdown menu trigger button"},selectionMode:{control:"select",options:["none","single","multi"],description:"The selection mode for the dropdown menu"},text:{control:"text",description:"The text content of the trigger button"},disabled:{control:"boolean",description:"Whether the dropdown menu is disabled"},popoverPlacement:{control:"select",options:["top","top-start","top-end","bottom","bottom-start","bottom-end","left","left-start","left-end","right","right-start","right-end"],description:"The placement of the popover relative to the trigger button"}},args:{open:!1,variant:"button",selectionMode:"none",text:"Choose model...",disabled:!1,popoverPlacement:"bottom-start"},render:e=>a`
...
}`,...t.parameters?.docs?.source}}};const f=["Demo","WithGroups","WithNestedMenus"],_=Object.freeze(Object.defineProperty({__proto__:null,Demo:n,WithGroups:r,WithNestedMenus:t,__namedExportsOrder:f,default:c},Symbol.toStringTag,{value:"Module"}));export{_ as A,n as D};
