import{r as B,i as F,x as h}from"./iframe-BTNck0jc.js";import{f as N,T as U,I as R,l as G,a as Y,m as V,n as K,o as j,p as J,q as Q}from"./scaffold-Bo7D00de.js";import"./split-button-CrbtY5VN.js";import{d as X,a as Z}from"./ai-sidebar-QTNwvnFa.js";import{d as ee}from"./index-9F7tV1_y.js";import{t as ae}from"./custom-element-UsVr97OX.js";import{n as _}from"./property-DYxdKUdm.js";import{n as D,e as E}from"./ref-C7dQ3PJs.js";import{n as te}from"./when-CI7b_ccM.js";import"./ai-modal-DETjCdVK.js";import"./ai-button-9HS-KKLq.js";import"./ai-disclaimer-BAePqgLM.js";import"./ai-chatbot-base-DKTkvwSe.js";import"./ai-chatbot-Cdibl69Q.js";import"./ai-message-thread-C0PM1fN5.js";import"./utils-JMyE3xw1.js";import{M as T}from"./mock-adapter-ls0PbTjH.js";function oe(){N(U)}const re=":host{display:block;height:100%}";var ie=Object.defineProperty,ne=Object.getOwnPropertyDescriptor,O=e=>{throw TypeError(e)},I=(e,t,i,l)=>{for(var c=l>1?void 0:l?ne(t,i):t,f=e.length-1,o;f>=0;f--)(o=e[f])&&(c=(l?o(t,i,c):o(c))||c);return l&&c&&ie(t,i,c),c},k=(e,t,i)=>t.has(e)||O("Cannot "+i),$=(e,t,i)=>(k(e,t,"read from private field"),i?i.call(e):t.get(e)),w=(e,t,i)=>t.has(e)?O("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,i),s=(e,t,i)=>(k(e,t,"access private method"),i),S,A,C,r,M,q,z,P,W,H,d;const se="forge-ai-sidebar-chat";let v=class extends F{constructor(){super(...arguments),w(this,r),this.open=!1,this.expanded=!1,w(this,S,E()),w(this,A,E()),w(this,C,h`
    <slot
      @forge-ai-chatbot-expand=${s(this,r,P)}
      @forge-ai-chatbot-minimize=${s(this,r,W)}></slot>
  `)}render(){return h`
      ${te(this.expanded,()=>h`
          <forge-ai-modal
            ${D($(this,A))}
            ?open=${this.open&&this.expanded}
            @forge-ai-modal-fullscreen-change=${s(this,r,z)}
            @forge-ai-modal-close=${s(this,r,H)}>
            ${$(this,C)}
          </forge-ai-modal>
        `,()=>h`
          <forge-ai-sidebar
    ...
    `}},b={},m={args:{open:!0},render:function(e){const t=o=>{a("forge-ai-disclaimer-agree")(o);const n=o.target?.closest("forge-ai-sidebar-chat"),y=n?.querySelector("forge-ai-disclaimer");if(y&&n){y.remove();const x=document.createElement("forge-ai-chatbot");x.setAttribute("show-minimize-button",""),n.appendChild(x)}},i=o=>{a("forge-ai-disclaimer-disagree")(o),o.target?.closest("forge-ai-sidebar-chat")?.close()},l=o=>{a("forge-ai-sidebar-chat-expand")(o);const n=o.target.querySelector("forge-ai-chatbot");n&&(n.expanded=!0)},c=o=>{a("forge-ai-sidebar-chat-collapse")(o);const n=o.target.querySelector("forge-ai-chatbot");n&&(n.expanded=!1)},f=h`
      <forge-ai-sidebar-chat
        ?open=${e.open}
        ?expanded=${e.expanded}
        @forge-ai-sidebar-chat-open=${a("forge-ai-sidebar-chat-open")}
    ...
    `}},u={args:{open:!0},render:function(e){const t=new T({simulateStreaming:!0,simulateTools:!1,streamingDelay:50,responseDelay:500}),i={name:"Staff Assistant",version:"1.3.5",identifier:"agent-49ff3a19-6986-43e9-a255-7bcdd40cbdc0",threadId:"7cbc1ec3-6fd1-4c13-a737-fc3d9f9ec2baf"},l=[{id:"thread-1",title:"TypeScript best practices",createdAt:new Date(Date.now()-7200*1e3).toISOString(),messageCount:8},{id:"thread-2",title:"Web component architecture",createdAt:new Date(Date.now()-300*60*1e3).toISOString(),messageCount:15},{id:"thread-3",title:"How to use localStorage?",createdAt:new Date(Date.now()-1440*60*1e3).toISOString(),messageCount:3},{id:"thread-4",title:"Lit reactive controllers explained",createdAt:new Date(Date.now()-2160*60*1e3).toISOString(),messageCount:12},{id:"thread-5",title:"CSS Grid vs Flexbox comparison",createdAt:new Date(Date.now()-2880*60*1e3).toISOString(),messageCount:6}],c=g=>{a("forge-ai-sidebar-chat-expand")(g);const p=g.target.querySelector("forge-ai-chatbot");p&&(p.expanded=!0)},f=g=>{a("forge-ai-sidebar-chat-collapse")(g);const p=g.target.querySelector("forge-ai-chatbot");p&&(p.expanded=!1)},o=a("forge-ai-chatbot-conversation-select"),n=a("forge-ai-chatbot-new-chat"),y=a("forge-ai-chatbot-conversations-open"),x=a("forge-ai-chatbot-conversations-close"),L=h`
      <forge-ai-sidebar-chat
        ...
        <forge-ai-chatbot
          ...
          @forge-ai-chatbot-clear=${a("forge-ai-chatbot-clear")}
          @forge-ai-chatbot-info=${a("forge-ai-chatbot-info")}
          @forge-ai-chatbot-conversation-select=${g=>o(g.detail)}
          @forge-ai-chatbot-new-chat=${n}
          @forge-ai-chatbot-conversations-open=${y}
...
}`,...u.parameters?.docs?.source}}};const le=["Demo","WithDisclaimer","WithConversationHistory"],Ee=Object.freeze(Object.defineProperty({__proto__:null,Demo:b,WithConversationHistory:u,WithDisclaimer:m,__namedExportsOrder:le,default:de},Symbol.toStringTag,{value:"Module"}));export{Ee as A};
