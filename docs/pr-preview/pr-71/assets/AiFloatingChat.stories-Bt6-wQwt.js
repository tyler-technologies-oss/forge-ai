import{r as z,i as F,x as p}from"./iframe-DohymFR3.js";import{t as q}from"./custom-element-UsVr97OX.js";import{n as C}from"./property-CxkMLdss.js";import{r as M}from"./class-map-DmicZuDw.js";import{n as k,e as H}from"./ref-bezBnNgu.js";import"./ai-dialog-ChECJxg9.js";import"./ai-fab-CX2t-FbE.js";import"./ai-disclaimer-ovXz93V_.js";import{M as S}from"./mock-adapter-ls0PbTjH.js";const W=":host{display:block}::slotted(forge-ai-chatbot){border-radius:calc(var(--forge-shape-large, 8px) * var(--forge-shape-factor, 1))}";var B=Object.defineProperty,L=Object.getOwnPropertyDescriptor,E=e=>{throw TypeError(e)},$=(e,a,n,h)=>{for(var c=h>1?void 0:h?L(a,n):a,o=e.length-1,i;o>=0;o--)(i=e[o])&&(c=(h?i(a,n,c):i(c))||c);return h&&c&&B(a,n,c),c},A=(e,a,n)=>a.has(e)||E("Cannot "+n),P=(e,a,n)=>(A(e,a,"read from private field"),n?n.call(e):a.get(e)),y=(e,a,n)=>a.has(e)?E("Cannot add the same private member more than once"):a instanceof WeakSet?a.add(e):a.set(e,n),s=(e,a,n)=>(A(e,a,"access private method"),n),w,r,D,_,I,T,d;const U="forge-ai-floating-chat";let m=class extends F{constructor(){super(...arguments),y(this,r),this.open=!1,this.expanded=!1,this._userExpanded=!1,y(this,w,H())}render(){return p`
      <forge-ai-dialog
        ${k(P(this,w))}
        ?open=${this.open}
        ?expanded=${this.expanded}
        @forge-ai-dialog-fullscreen-change=${s(this,r,D)}
        @forge-ai-dialog-close=${s(this,r,T)}>
        <slot
          @forge-ai-chatbot-expand=${s(this,r,_)}
          @forge-ai-chatbot-minimize=${s(this,r,I)}></slot>
      </forge-ai-dialog>
    `}show(){this.open=!0,s(this,r,d).call(this,"forge-ai-floating-chat-open")}close(){this.expanded&&(this.expanded=!1,s(this,r,d).call(this,"forge-ai-floating-chat-collapse")),this.open=!1,s(this,r,d).call(this,"forge-ai-floating-chat-close")}toggle(){this.open?this.close():this.show()}expand(){this.expanded||(this.expanded=!0,this._userExpanded=!0,s(this,r,d).call(this,"forge-ai-floating-chat-expand"))}collapse(){this.expanded&&(this.expanded=!1,this._userExpanded=!1,s(this,r,d).call(this,"forge-ai-floating-chat-collapse"))}};w=new WeakMap;r=new WeakSet;D=function(e){const{isFullscreen:a}=e.detail;a&&!this.expanded?(this.expanded=!0,s(this,r,d).call(this,"forge-ai-floating-chat-expand")):!a&&this.expanded&&!this._userExpanded&&(this.expanded=!1,s(this,r,d).call(this,"forge-ai-floating-chat-collapse"))};_=function(){this.expanded=!this.expanded,this._userExpanded=this.expanded,this.expanded?s(this,r,d).call(this,"forge-ai-floating-chat-expand"):s(this,r,d).call(this,"forge-ai-floating-chat-collapse")};I=function(){this.close()};T=function(){this.open&&this.close()};d=function(e){const a=new CustomEvent(e,{bubbles:!0,composed:!0});this.dispatchEvent(a)};m.styles=z(W);$([C({type:Boolean})],m.prototype,"open",2);$([C({type:Boolean})],m.prototype,"expanded",2);$([M()],m.prototype,"_userExpanded",2);m=$([q(U)],m);const{action:t}=__STORYBOOK_MODULE_ACTIONS__,N="forge-ai-floating-chat",G={title:"AI Components/Form Factors/Floating",component:N,argTypes:{adapter:{control:!1,description:"The adapter for communication with the AI service"},open:{control:{type:"boolean"},description:"Controls whether the chat is open"},expanded:{control:{type:"boolean"},description:"Controls whether the chat is displayed in an expanded state"},fileUpload:{control:{type:"select"},options:["on","off"],description:"Enable file upload functionality"},placeholder:{control:"text",description:"Placeholder text for input"}},args:{open:!1,expanded:!1,fileUpload:"off",placeholder:"Ask a question..."},render:e=>{const a=new S({simulateStreaming:!0,simulateTools:!1,streamingDelay:50,responseDelay:500}),n={name:"Staff Assistant",version:"1.3.5",identifier:"agent-49ff3a19-6986-43e9-a255-7bcdd40cbdc0",threadId:"7cbc1ec3-6fd1-4c13-a737-fc3d9f9ec2baf"},h=l=>{t("forge-ai-floating-chat-expand")(l);const f=l.target.querySelector("forge-ai-chatbot");f&&(f.expanded=!0)},c=l=>{t("forge-ai-floating-chat-collapse")(l);const f=l.target.querySelector("forge-ai-chatbot");f&&(f.expanded=!1)},o=p`
    ...
    `}},u={},v={args:{open:!0},render:function(e){const a=o=>{t("forge-ai-disclaimer-agree")(o);const i=o.target?.closest("forge-ai-floating-chat"),l=i?.querySelector("forge-ai-disclaimer");if(l&&i){l.remove();const f=document.createElement("forge-ai-chatbot");f.setAttribute("show-minimize-button",""),i.appendChild(f)}},n=o=>{t("forge-ai-disclaimer-disagree")(o),o.target?.closest("forge-ai-floating-chat")?.close()},h=o=>{t("forge-ai-floating-chat-expand")(o);const i=o.target.querySelector("forge-ai-chatbot");i&&(i.expanded=!0)},c=o=>{t("forge-ai-floating-chat-collapse")(o);const i=o.target.querySelector("forge-ai-chatbot");i&&(i.expanded=!1)};return p`
      <div style="min-height: 300px;">
        <div>
    ...
    `}},x={args:{open:!0},render:function(e){const a=new S({simulateStreaming:!0,simulateTools:!1,streamingDelay:50,responseDelay:500}),n={name:"Staff Assistant",version:"1.3.5",identifier:"agent-49ff3a19-6986-43e9-a255-7bcdd40cbdc0",threadId:"7cbc1ec3-6fd1-4c13-a737-fc3d9f9ec2baf"},h=[{id:"thread-1",title:"TypeScript best practices",createdAt:new Date(Date.now()-7200*1e3).toISOString(),messageCount:8},{id:"thread-2",title:"Web component architecture",createdAt:new Date(Date.now()-300*60*1e3).toISOString(),messageCount:15},{id:"thread-3",title:"How to use localStorage?",createdAt:new Date(Date.now()-1440*60*1e3).toISOString(),messageCount:3},{id:"thread-4",title:"Lit reactive controllers explained",createdAt:new Date(Date.now()-2160*60*1e3).toISOString(),messageCount:12},{id:"thread-5",title:"CSS Grid vs Flexbox comparison",createdAt:new Date(Date.now()-2880*60*1e3).toISOString(),messageCount:6}],c=g=>{t("forge-ai-floating-chat-expand")(g);const b=g.target.querySelector("forge-ai-chatbot");b&&(b.expanded=!0)},o=g=>{t("forge-ai-floating-chat-collapse")(g);const b=g.target.querySelector("forge-ai-chatbot");b&&(b.expanded=!1)},i=t("forge-ai-chatbot-conversation-select"),l=t("forge-ai-chatbot-new-chat"),f=t("forge-ai-chatbot-conversations-open"),O=t("forge-ai-chatbot-conversations-close");return p`
      <div style="min-height: 300px;">
        ...
        <forge-ai-floating-chat
          ...
          @forge-ai-floating-chat-open=${t("forge-ai-floating-chat-open")}
          @forge-ai-floating-chat-close=${t("forge-ai-floating-chat-close")}
          @forge-ai-floating-chat-expand=${c}
          ...
          <forge-ai-chatbot
            ...
            @forge-ai-chatbot-clear=${t("forge-ai-chatbot-clear")}
            @forge-ai-chatbot-info=${t("forge-ai-chatbot-info")}
            @forge-ai-chatbot-conversation-select=${g=>i(g.detail)}
            @forge-ai-chatbot-new-chat=${l}
            @forge-ai-chatbot-conversations-open=${f}
