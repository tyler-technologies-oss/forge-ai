import{x as d}from"./iframe-DjaQ0J0C.js";import{I as p,c,d as l,e as f,f as g,g as m,h,i as u}from"./icon-registry-D8cCWsde.js";import{d as y,a as b}from"./ai-sidebar-CvictfxG.js";import"./ai-chat-interface-B4v1zptg.js";import"./ai-prompt-C1MgwYlt.js";import"./ai-chat-header-CN4bIDW1.js";import"./ai-user-message-uVzZNv2h.js";import"./ai-response-message-bYiYEqVI.js";import"./ai-button-BxepRx4-.js";import{d as I}from"./index-r1dyYakP.js";const{action:r}=__STORYBOOK_MODULE_ACTIONS__;y();b();I();p.define([c,l,f,g,m,h,u]);const w="forge-ai-sidebar",x={title:"AI Components/Primitives/Sidebar",component:w,argTypes:{open:{control:{type:"boolean"},description:"Controls whether the sidebar is open"},expanded:{control:{type:"boolean"},description:"Controls whether the sidebar is displayed in an expanded state"}},args:{open:!1,expanded:!1},render:a=>{const t=r("forge-ai-sidebar-open"),i=r("forge-ai-sidebar-close"),s=()=>{const e=document.querySelector("forge-ai-chat-interface");e&&(e.expanded=!e.expanded)},n=()=>{document.querySelector("forge-ai-sidebar")?.close()};return d`
