import{x as h}from"./iframe-DNPZiRV8.js";import"./ai-chatbot-Cx9SA98c.js";import{M as m}from"./mock-adapter-_zUjDDpK.js";import"./ai-empty-state-CzQzg6oh.js";import"./ai-suggestions-2MOWzyUn.js";import"./ai-voice-input-DciOp5aI.js";const{action:t}=__STORYBOOK_MODULE_ACTIONS__,v="forge-ai-chatbot",w={title:"AI Components/Primitives/Chatbot",component:v,argTypes:{placeholder:{control:"text",description:"Placeholder text for the input field"},fileUpload:{control:"select",options:["enabled","disabled"],description:"Enable file upload functionality"},voiceInput:{control:"select",options:["enabled","disabled"],description:"Enable voice input functionality"},showExpandButton:{control:"boolean",description:"Show expand button in header"},showMinimizeButton:{control:"boolean",description:"Show minimize button in header"},expanded:{control:"boolean",description:"Expanded state (affects icon display)"},minimizeIcon:{control:"select",options:["default","panel"],description:"Minimize icon variant"},enableReactions:{control:"boolean",description:"Enable thumbs up/down reaction buttons"}},args:{placeholder:"Ask a question...",fileUpload:"disabled",voiceInput:"enabled",showExpandButton:!1,showMinimizeButton:!1,expanded:!1,minimizeIcon:"default",enableReactions:!1},render:e=>{const a=new m({simulateStreaming:!0,simulateTools:!1,streamingDelay:50,responseDelay:500}),i=t("forge-ai-chatbot-connected"),r=t("forge-ai-chatbot-disconnected"),o=t("forge-ai-chatbot-message-sent"),p=t("forge-ai-chatbot-message-received"),n=t("forge-ai-chatbot-tool-call"),g=t("forge-ai-chatbot-error"),u=t("forge-ai-chatbot-expand"),b=t("forge-ai-chatbot-minimize"),f=t("forge-ai-chatbot-clear"),$=t("forge-ai-chatbot-export"),x=t("forge-ai-chatbot-info");return h`
    ...
    `}},s={},c={render:e=>{const a=new m({simulateStreaming:!0,simulateTools:!1,streamingDelay:50,responseDelay:500});return h`
      <div style="width: 100%; height: 600px; max-width: 800px; margin: 0 auto;">
        <forge-ai-chatbot
          .adapter=${a}
    ...
    `}},d={args:{showMinimizeButton:!0},render:e=>{const a="ai-chatbot-thread-state",i=new m({simulateStreaming:!0,simulateTools:!1,streamingDelay:50,responseDelay:500}),r=[{text:"What is TypeScript?",value:"typescript"},{text:"Explain web components",value:"webcomponents"},{text:"How do I use localStorage?",value:"localstorage"}];return setTimeout(()=>{const o=document.querySelector("forge-ai-chatbot");if(!o)return;const p=localStorage.getItem(a);if(p)try{const n=JSON.parse(p);o.setThreadState(n)}catch(n){console.error("Failed to restore thread state:",n)}o.addEventListener("forge-ai-chatbot-message-received",()=>{const n=o.getThreadState();localStorage.setItem(a,JSON.stringify(n))}),o.addEventListener("forge-ai-chatbot-message-sent",()=>{const n=o.getThreadState();localStorage.setItem(a,JSON.stringify(n))}),o.addEventListener("forge-ai-chatbot-clear",()=>{localStorage.removeItem(a)})},0),h`
      <div style="width: 100%; height: 600px; max-width: 800px; margin: 0 auto;">
...
}`,...d.parameters?.docs?.source}}};const y=["Demo","WithSuggestions","WithTools","WithPersistence"],D=Object.freeze(Object.defineProperty({__proto__:null,Demo:s,WithPersistence:d,WithSuggestions:c,WithTools:l,__namedExportsOrder:y,default:w},Symbol.toStringTag,{value:"Module"}));export{D as A,s as D};
