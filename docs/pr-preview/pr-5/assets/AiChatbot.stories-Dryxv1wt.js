import{x as h}from"./iframe-Bbo3iDA_.js";import"./ai-chatbot-BbQ7wO2g.js";import{M as m}from"./mock-adapter-_zUjDDpK.js";import"./ai-empty-state-wawAPfW9.js";import"./ai-suggestions-2KRNfLLP.js";import"./ai-voice-input-BGtROpwc.js";const{action:t}=__STORYBOOK_MODULE_ACTIONS__,v="forge-ai-chatbot",w={title:"AI Components/Primitives/Chatbot",component:v,argTypes:{placeholder:{control:"text",description:"Placeholder text for the input field"},fileUpload:{control:"select",options:["enabled","off"],description:"Enable file upload functionality"},voiceInput:{control:"select",options:["enabled","off"],description:"Enable voice input functionality"},showExpandButton:{control:"boolean",description:"Show expand button in header"},showMinimizeButton:{control:"boolean",description:"Show minimize button in header"},expanded:{control:"boolean",description:"Expanded state (affects icon display)"},minimizeIcon:{control:"select",options:["default","panel"],description:"Minimize icon variant"},enableReactions:{control:"boolean",description:"Enable thumbs up/down reaction buttons"}},args:{placeholder:"Ask a question...",fileUpload:"off",voiceInput:"enabled",showExpandButton:!1,showMinimizeButton:!1,expanded:!1,minimizeIcon:"default",enableReactions:!1},render:e=>{const a=new m({simulateStreaming:!0,simulateTools:!1,streamingDelay:50,responseDelay:500}),i=t("forge-ai-chatbot-connected"),r=t("forge-ai-chatbot-disconnected"),o=t("forge-ai-chatbot-message-sent"),p=t("forge-ai-chatbot-message-received"),n=t("forge-ai-chatbot-tool-call"),g=t("forge-ai-chatbot-error"),u=t("forge-ai-chatbot-expand"),b=t("forge-ai-chatbot-minimize"),f=t("forge-ai-chatbot-clear"),$=t("forge-ai-chatbot-export"),x=t("forge-ai-chatbot-info");return h`
