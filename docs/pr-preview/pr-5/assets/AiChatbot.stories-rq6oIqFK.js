import{x as h}from"./iframe-DjaQ0J0C.js";import"./ai-chatbot-Cf89Olsl.js";import{M as m}from"./mock-adapter-_zUjDDpK.js";import"./ai-empty-state-Btaf0jV5.js";import"./ai-suggestions-DvcPpKJD.js";import"./ai-voice-input-D1zER7O1.js";const{action:t}=__STORYBOOK_MODULE_ACTIONS__,v="forge-ai-chatbot",w={title:"AI Components/Primitives/Chatbot",component:v,argTypes:{placeholder:{control:"text",description:"Placeholder text for the input field"},enableFileUpload:{control:"boolean",description:"Enable file upload functionality"},enableVoiceInput:{control:"boolean",description:"Enable voice input functionality"},showExpandButton:{control:"boolean",description:"Show expand button in header"},showMinimizeButton:{control:"boolean",description:"Show minimize button in header"},expanded:{control:"boolean",description:"Expanded state (affects icon display)"},minimizeIcon:{control:"select",options:["default","panel"],description:"Minimize icon variant"},enableReactions:{control:"boolean",description:"Enable thumbs up/down reaction buttons"}},args:{placeholder:"Ask a question...",enableFileUpload:!1,enableVoiceInput:!0,showExpandButton:!1,showMinimizeButton:!1,expanded:!1,minimizeIcon:"default",enableReactions:!1},render:e=>{const o=new m({simulateStreaming:!0,simulateTools:!1,streamingDelay:50,responseDelay:500}),i=t("forge-ai-chatbot-connected"),r=t("forge-ai-chatbot-disconnected"),a=t("forge-ai-chatbot-message-sent"),p=t("forge-ai-chatbot-message-received"),n=t("forge-ai-chatbot-tool-call"),g=t("forge-ai-chatbot-error"),u=t("forge-ai-chatbot-expand"),b=t("forge-ai-chatbot-minimize"),f=t("forge-ai-chatbot-clear"),$=t("forge-ai-chatbot-export"),x=t("forge-ai-chatbot-info");return h`
    ...
    `}},s={},c={render:e=>{const o=new m({simulateStreaming:!0,simulateTools:!1,streamingDelay:50,responseDelay:500});return h`
      <div style="width: 100%; height: 600px; max-width: 800px; margin: 0 auto;">
        <forge-ai-chatbot
          .adapter=${o}
    ...
    `}},d={args:{showMinimizeButton:!0},render:e=>{const o="ai-chatbot-thread-state",i=new m({simulateStreaming:!0,simulateTools:!1,streamingDelay:50,responseDelay:500}),r=[{text:"What is TypeScript?",value:"typescript"},{text:"Explain web components",value:"webcomponents"},{text:"How do I use localStorage?",value:"localstorage"}];return setTimeout(()=>{const a=document.querySelector("forge-ai-chatbot");if(!a)return;const p=localStorage.getItem(o);if(p)try{const n=JSON.parse(p);a.setThreadState(n)}catch(n){console.error("Failed to restore thread state:",n)}a.addEventListener("forge-ai-chatbot-message-received",()=>{const n=a.getThreadState();localStorage.setItem(o,JSON.stringify(n))}),a.addEventListener("forge-ai-chatbot-message-sent",()=>{const n=a.getThreadState();localStorage.setItem(o,JSON.stringify(n))}),a.addEventListener("forge-ai-chatbot-clear",()=>{localStorage.removeItem(o)})},0),h`
      <div style="width: 100%; height: 600px; max-width: 800px; margin: 0 auto;">
