import{r as d,i as h,x as t}from"./iframe-Cs5ZdWGX.js";import{t as c}from"./custom-element-UsVr97OX.js";import{n as l}from"./property-sdxP6XNC.js";const f='@keyframes fadein{0%{opacity:0}to{opacity:1}}:host{display:block}.button-header{display:grid;grid-template-columns:56px 1fr auto;align-items:center;padding:0;width:100%;background:none;border:none;cursor:pointer;text-align:start}.button-header svg{fill:var(--forge-theme-text-medium);height:24px;width:24px}.button-header-text{-moz-osx-font-smoothing:grayscale;-webkit-font-smoothing:antialiased;font-family:var(--forge-typography-body2-font-family, var(--forge-typography-font-family, "Roboto", sans-serif));font-size:var(--forge-typography-body2-font-size, calc(var(--forge-typography-font-size, 1rem) * var(--forge-typography-body-font-size-scale, 1)));font-weight:var(--forge-typography-body2-font-weight, 400);line-height:var(--forge-typography-body2-line-height, calc(var(--forge-typography-font-size, 1rem) * var(--forge-typography-body-line-height-scale, 1.375)));letter-spacing:var(--forge-typography-body2-letter-spacing, .015625em);text-transform:var(--forge-typography-body2-text-transform, inherit);text-decoration:var(--forge-typography-body2-text-decoration, inherit);color:var(--forge-theme-text-medium, rgba(0, 0, 0, .6));flex:1}';var y=Object.defineProperty,m=Object.getOwnPropertyDescriptor,p=(g,r,n,a)=>{for(var e=a>1?void 0:a?m(r,n):r,s=g.length-1,i;s>=0;s--)(i=g[s])&&(e=(a?i(r,n,e):i(e))||e);return a&&e&&y(r,n,e),e};const v="forge-ai-reasoning-header";let o=class extends h{constructor(){super(...arguments),this.expanded=!1,this.reasoning=!1}_handleClick(){this.expanded=!this.expanded,this.dispatchEvent(new CustomEvent("toggle",{detail:{expanded:this.expanded},bubbles:!0,composed:!0}))}render(){return t`
      <button
        ...
        ${this.expanded?t`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="forge-icon" aria-hidden="true">
                <path d="M7.41 15.41 12 10.83l4.59 4.58L18 14l-6-6-6 6z" />
              </svg>`:t`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="forge-icon" aria-hidden="true">
                <path d="M7.41 8.58 12 13.17l4.59-4.59L18 10l-6 6-6-6z" />
              </svg>`}
      </button>
    `}};o.styles=d(f);p([l({type:Boolean,reflect:!0})],o.prototype,"expanded",2);p([l({type:Boolean,reflect:!0})],o.prototype,"reasoning",2);o=p([c(v)],o);
