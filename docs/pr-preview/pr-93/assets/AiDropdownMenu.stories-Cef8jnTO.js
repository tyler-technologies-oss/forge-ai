import{x as a}from"./iframe-Cs5ZdWGX.js";import"./ai-dropdown-menu-Dq1eTt5b.js";import"./ai-dropdown-menu-item-B6bdAqtH.js";import{I as d,i as p,j as m,k as s}from"./scaffold-DxExeDzo.js";import"./split-button-DO3wAA6w.js";import{d as u}from"./index-CSlp79KF.js";const{action:l}=__STORYBOOK_MODULE_ACTIONS__;u();d.define([p,m,s]);const g="forge-ai-dropdown-menu",i=l("forge-ai-dropdown-menu-change"),c={title:"AI Components/Primitives/Dropdown Menu",component:g,argTypes:{variant:{control:"select",options:["button","icon-button"],description:"The variant of the dropdown menu trigger button"},selectionMode:{control:"select",options:["none","single","multi"],description:"The selection mode for the dropdown menu"},text:{control:"text",description:"The text content of the trigger button"},triggerLabel:{control:"text",description:"Accessible label for the trigger button. Set this for icon-only triggers with no visible text."},disabled:{control:"boolean",description:"Whether the dropdown menu is disabled"},popoverPlacement:{control:"select",options:["top","top-start","top-end","bottom","bottom-start","bottom-end","left","left-start","left-end","right","right-start","right-end"],description:"The placement of the popover relative to the trigger button"}},args:{open:!1,variant:"button",selectionMode:"none",text:"Choose model...",triggerLabel:"",disabled:!1,popoverPlacement:"bottom-start"},render:e=>a`
      <forge-ai-dropdown-menu
        .open=${e.open}
        variant=${e.variant}
        selection-mode=${e.selectionMode}
        popover-placement=${e.popoverPlacement}
        trigger-label=${e.triggerLabel||void 0}
        ?disabled=${e.disabled}
...
}`,...t.parameters?.docs?.source}}};const f=["Demo","WithGroups","WithNestedMenus"],x=Object.freeze(Object.defineProperty({__proto__:null,Demo:n,WithGroups:r,WithNestedMenus:t,__namedExportsOrder:f,default:c},Symbol.toStringTag,{value:"Module"}));export{x as A,n as D};
