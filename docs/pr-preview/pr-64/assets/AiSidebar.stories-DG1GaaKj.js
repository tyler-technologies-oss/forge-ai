import{x as d}from"./iframe-uGLD-tBn.js";import{I as p,j as c,k as l,l as f,m,n as g,o as h,p as u}from"./split-button-BMyaWCcq.js";import{d as y,a as b}from"./ai-sidebar-B-bu7ZGA.js";import{d as I}from"./index-CAdlJLPF.js";import"./ai-chat-interface-De7iCfj_.js";import"./ai-prompt-BaP6Cv9V.js";import"./ai-chat-header-B5atUPaO.js";import"./ai-user-message-D_KQR5nf.js";import"./ai-response-message-C900u20n.js";import"./ai-button-ooM4Fhth.js";const{action:r}=__STORYBOOK_MODULE_ACTIONS__;y();b();I();p.define([c,l,f,m,g,h,u]);const w="forge-ai-sidebar",x={title:"AI Components/Primitives/Sidebar",component:w,argTypes:{open:{control:{type:"boolean"},description:"Controls whether the sidebar is open"},expanded:{control:{type:"boolean"},description:"Controls whether the sidebar is displayed in an expanded state"}},args:{open:!1,expanded:!1},render:a=>{const t=r("forge-ai-sidebar-open"),i=r("forge-ai-sidebar-close"),s=()=>{const e=document.querySelector("forge-ai-chat-interface");e&&(e.expanded=!e.expanded)},n=()=>{document.querySelector("forge-ai-sidebar")?.close()};return d`
