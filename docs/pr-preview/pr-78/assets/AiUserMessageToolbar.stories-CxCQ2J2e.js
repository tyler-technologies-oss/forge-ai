import{x as m}from"./iframe-CPAyPH5b.js";import"./ai-user-message-toolbar-B85STB3S.js";const{action:e}=__STORYBOOK_MODULE_ACTIONS__,g="forge-ai-user-message-toolbar",d={title:"AI Components/Primitives/User Message Toolbar",component:g,argTypes:{timestamp:{control:"number",description:"Timestamp to display (Unix timestamp in milliseconds)"},streaming:{control:"boolean",description:"Whether the AI is currently streaming a response (disables resend/edit buttons)"}},args:{timestamp:Date.now(),streaming:!1},render:a=>{const t=e("forge-ai-user-message-toolbar-copy"),n=e("forge-ai-user-message-toolbar-resend"),i=e("forge-ai-user-message-toolbar-edit");return m`
