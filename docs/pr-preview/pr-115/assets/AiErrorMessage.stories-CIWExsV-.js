import{x as o}from"./iframe-RRnsZQGs.js";import"./ai-error-message-PO7j5vW9.js";const t="forge-ai-error-message",a={title:"AI Components/Primitives/Error Message",component:t,argTypes:{density:{control:"select",options:["medium","small"],description:'The density of the banner. "small" tightens the padding, gap, and icon for compact surfaces'}},args:{density:"medium"},render:s=>o`
