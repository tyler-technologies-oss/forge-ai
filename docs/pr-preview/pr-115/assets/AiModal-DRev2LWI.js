import{j as e,M as t,T as r,C as l}from"./blocks-D-jryxvQ.js";import{useMDXComponents as s}from"./index-bHPF_ebq.js";import{C as d}from"./CustomArgTypes-DK9gOOsK.js";import{A as c,D as a}from"./AiModal.stories-BceOEh_R.js";import"./preload-helper-PPVm8Dsz.js";import"./_commonjsHelpers-CqkleIqs.js";import"./iframe-D1C_cP03.js";import"./utils-BQbSAUyf.js";import"./ref-Dfxh5cwS.js";import"./class-map-BLwfprfL.js";import"./ai-modal-8QPUUvBa.js";import"./custom-element-UsVr97OX.js";import"./property-B5TE8D88.js";import"./state-BoHpUCf1.js";import"./query-C-MXZcjm.js";import"./utils-DIqd7FWX.js";function i(o){const n={code:"code",h2:"h2",li:"li",p:"p",strong:"strong",ul:"ul",...s(),...o.components};return e.jsxs(e.Fragment,{children:[e.jsx(t,{of:c}),`
`,e.jsx(r,{}),`
...
`]}),`
`,e.jsxs(n.p,{children:["The dialog is labelled via the ",e.jsx(n.code,{children:"label"})," property (default: ",e.jsx(n.code,{children:'"AI Assistant"'}),"), which is applied as the dialog's ",e.jsx(n.code,{children:"aria-label"})," so screen readers announce a meaningful name when the modal opens. Set ",e.jsx(n.code,{children:"label"})," to match the content shown in your modal."]})]})}function D(o={}){const{wrapper:n}={...s(),...o.components};return n?e.jsx(n,{...o,children:e.jsx(i,{...o})}):i(o)}export{D as default};
