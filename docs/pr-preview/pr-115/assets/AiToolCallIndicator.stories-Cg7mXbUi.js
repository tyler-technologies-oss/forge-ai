import{x as d}from"./iframe-D9OWRBHb.js";import"./ai-message-thread-D3HQgbui.js";import"./ai-chatbot-base-Ds_pintQ.js";import"./ai-chatbot-DecXx7RE.js";import{A as g}from"./agent-adapter-BpTdLjYO.js";import{g as i}from"./utils-CwmN9dOd.js";const h="forge-ai-tool-call-indicator",u=new Map([["getCurrentWeather",{name:"getCurrentWeather",displayName:"Get current weather"}]]),p=[{id:"tool-1",messageId:"message-1",name:"getCurrentWeather",args:{location:"San Francisco"},result:{temperature:68,condition:"Sunny"},status:"complete",type:"agent",startTimestamp:1e3,endTimestamp:1420},{id:"tool-2",messageId:"message-1",name:"lookup_case",args:{caseId:"CASE-123"},result:{message:"Case not found"},status:"error",type:"agent",startTimestamp:1420,endTimestamp:2210}];class f extends g{#e="case-lookup-demo-thread";get threadId(){return this.#e}set threadId(n){this.#e=n}async connect(){this._updateState({isConnected:!0})}async disconnect(){this._updateState({isConnected:!1})}sendMessage(n){this._updateState({isRunning:!0}),this._emitRunStarted();const e=i(),t=i(),r="lookup_case",l={caseId:"CASE-123"};this._emitMessageStart(e),this._emitMessageDelta(e,"I'll look that case up for you."),this._emitMessageEnd(e),setTimeout(()=>{this._emitToolCallStart({id:t,messageId:e,name:r}),this._emitToolCallArgs({id:t,messageId:e,name:r,argsBuffer:JSON.stringify(l),partialArgs:l}),this._emitToolCallEnd({id:t,messageId:e,name:r,args:l}),this._emitToolCall({id:t,messageId:e,name:r,args:l}),setTimeout(()=>{const m={message:"Case not found"};this._emitToolResult({toolCallId:t,result:m,isError:!0,message:{id:i(),role:"tool",content:JSON.stringify(m),timestamp:Date.now(),status:"error",toolCallId:t}}),this._updateState({isRunning:!1}),this._emitRunFinished()},700)},500)}sendToolResult(){}abort(){this._updateState({isRunning:!1})}}const C={title:"AI Components/Primitives/Tool Call Indicator",component:h,tags:["autodocs"]},o={render:()=>d`
  ...
  `},s={render:()=>{const c=new f;return d`
...
}`,...s.parameters?.docs?.source}}};const _=["Demo","DebugMode","FailedToolCallFromAdapter"],k=Object.freeze(Object.defineProperty({__proto__:null,DebugMode:a,Demo:o,FailedToolCallFromAdapter:s,__namedExportsOrder:_,default:C},Symbol.toStringTag,{value:"Module"}));export{k as A,o as D,s as F,a};
