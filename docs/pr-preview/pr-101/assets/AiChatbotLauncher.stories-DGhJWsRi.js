import{x as c}from"./iframe-DiOCH7Dj.js";import{n as S}from"./ref-DgWQRCQ7.js";import"./ai-chatbot-launcher-QYuaeYKJ.js";import{M as d}from"./mock-adapter-ph_xQ6k2.js";import{s as D}from"./utils-DkDZKAQP.js";import{I,t as R,a as A}from"./scaffold-DT2z-NGc.js";import"./split-button-CTh06gCM.js";import{d as M}from"./index-DFJiSE3d.js";import{d as k}from"./index-Ce5YL2q0.js";const{action:a}=__STORYBOOK_MODULE_ACTIONS__,L="forge-ai-chatbot-launcher",U={title:"AI Components/Form Factors/Launcher",component:L,argTypes:{placeholder:{control:"text",description:"Placeholder text for the input field"},titleText:{control:"text",description:"Title text displayed in the welcome view"},descriptionText:{control:"text",description:"Description text displayed below the title"},fileUpload:{control:"select",options:["on","off"],description:"Enable file upload functionality"},voiceInput:{control:"select",options:["on","off"],description:"Enable voice input functionality"},exportOption:{control:"select",options:["on","off"],description:"Control export option visibility"},enableReactions:{control:"boolean",description:"Enable thumbs up/down reaction buttons"},disclaimerText:{control:"text",description:"Disclaimer text displayed below the prompt"},threadName:{control:"text",description:"Thread name displayed in conversation view breadcrumb"},showConversationRename:{control:"boolean",description:"Show rename option in thread actions menu"},showConversationDelete:{control:"boolean",description:"Show delete option in thread actions menu"},totalThreads:{control:"number",description:"Total number of chats available for the history popover/view. Greater than loaded threads enables infinite scroll"},threadsLoading:{control:"boolean",description:"Whether chats are loading, used to gate the history button and its disabled state"}},args:{placeholder:"How can I help you today?",titleText:"AI Assistant",descriptionText:"",fileUpload:"on",voiceInput:"on",exportOption:"on",enableReactions:!1,disclaimerText:"AI can make mistakes. Always verify responses."},render:e=>{const o=new d({simulateStreaming:!0,simulateTools:!1,streamingDelay:50,responseDelay:500}),r=a("forge-ai-chatbot-launcher-connected"),s=a("forge-ai-chatbot-launcher-message-sent"),i=a("forge-ai-chatbot-launcher-message-received"),t=a("forge-ai-chatbot-launcher-tool-call"),n=a("forge-ai-chatbot-launcher-error"),l=a("forge-ai-chatbot-launcher-conversation-start"),h=a("forge-ai-chatbot-launcher-clear"),$=a("forge-ai-chatbot-launcher-response-feedback"),x=a("forge-ai-chatbot-launcher-info"),C=a("forge-ai-chatbot-launcher-agent-change");return c`
      <div
        ...
        <forge-ai-chatbot-launcher
          ...
          @forge-ai-chatbot-launcher-response-feedback=${w=>$(w.detail)}
          @forge-ai-chatbot-launcher-info=${x}
          @forge-ai-chatbot-launcher-agent-change=${w=>C(w.detail)}>
        </forge-ai-chatbot-launcher>
      </div>
    `}},u={},p={args:{threadName:"Discussion about project requirements and timeline",showConversationRename:!0,showConversationDelete:!0},render:e=>{const o=new d({simulateStreaming:!0,simulateTools:!1,streamingDelay:50,responseDelay:500}),r=a("forge-ai-chatbot-launcher-thread-rename"),s=a("forge-ai-chatbot-launcher-thread-delete");return c`
      <div
        style="width: 100%; height: 600px; max-width: 900px; margin: 0 auto; border: 1px solid #e0e0e0; border-radius: 8px; overflow: hidden;">
        <forge-ai-chatbot-launcher
          .adapter=${o}
    ...
    `}},f={...D,render:e=>{const o=new d({simulateStreaming:!0,simulateTools:!1,streamingDelay:50,responseDelay:500});return c`
      <div
        style="width: 100%; height: 600px; max-width: 900px; margin: 0 auto; border: 1px solid #e0e0e0; border-radius: 8px; overflow: hidden;">
        <forge-ai-chatbot-launcher
          .adapter=${o}
    ...
    `}},T=["API integration help","Debugging production issue","Performance optimization","Database schema design","Testing strategies","Code review feedback","Deployment questions","Security best practices","UI/UX improvements","Refactoring advice"],y=[0,.5,2,6,12,20,30,36,72,120,240,504,1080,2160,4800,24*400],O=(e,o=0)=>Array.from({length:e},(r,s)=>{const i=o+s,t=y[i%y.length];return{id:`thread-${i+1}`,title:T[i%T.length],createdAt:new Date(Date.now()-t*36e5).toISOString()}}),E=e=>{const o=Date.now()-864e5;return[{id:`${e.id}-msg-1`,role:"user",content:`Can you help me with ${e.title.toLowerCase()}?`,timestamp:o,status:"complete"},{id:`${e.id}-msg-2`,role:"assistant",content:`Of course! Here's what I'd suggest for ${e.title.toLowerCase()}. Let me know if you'd like more detail.`,timestamp:o+5e3,status:"complete"}]},b={args:{showConversationRename:!0,showConversationDelete:!0,totalThreads:24,threadsLoading:!1},render:e=>{const o=new d({simulateStreaming:!0,simulateTools:!1,streamingDelay:50,responseDelay:500}),r=O(24),s=new Map(r.map(t=>[t.id,E(t)]));let i=null;return c`
      <div
        ...
        <forge-ai-chatbot-launcher
          ...
          @forge-ai-chatbot-launcher-thread-load-more=${t=>{const{query:n,appendResults:l}=t.detail;setTimeout(()=>{const h=n?r.filter(x=>x.title.toLowerCase().includes(n.toLowerCase())):r,$=i?.threads.length??0;l(h.slice($,$+10))},500)}}
    ...
    `}},v={render:e=>{k(),M(),I.define([R,A]);const o=new d({simulateStreaming:!0,simulateTools:!1,streamingDelay:50,responseDelay:500});return c`
      <div
        style="width: 100%; height: 600px; max-width: 900px; margin: 0 auto; border: 1px solid #e0e0e0; border-radius: 8px; overflow: hidden;">
        <forge-ai-chatbot-launcher
          .adapter=${o}
...
}`,...v.parameters?.docs?.source}}};const _=["Demo","WithThreadName","WithSuggestions","FullPage","WithCustomHeader","WithHistory","WithHeaderActions"],G=Object.freeze(Object.defineProperty({__proto__:null,Demo:u,FullPage:g,WithCustomHeader:f,WithHeaderActions:v,WithHistory:b,WithSuggestions:m,WithThreadName:p,__namedExportsOrder:_,default:U},Symbol.toStringTag,{value:"Module"}));export{G as A,b as W};
