import{r as z,i as F,x as m}from"./iframe-BSmKQs1u.js";import{t as k}from"./custom-element-UsVr97OX.js";import{n as y}from"./property-BGszvd3v.js";import{r as q}from"./class-map-DMblrozl.js";import{n as M,e as H}from"./ref-Ts25pZNB.js";import"./ai-dialog-CMIVI-eQ.js";import"./ai-fab-B0ttG_-j.js";import"./ai-disclaimer-DQ8Z6Sw2.js";import{M as S}from"./mock-adapter-BpgeerXX.js";const W=":host{display:block}::slotted(forge-ai-chatbot){border-radius:calc(var(--forge-shape-large, 8px) * var(--forge-shape-factor, 1))}";var B=Object.defineProperty,L=Object.getOwnPropertyDescriptor,A=e=>{throw TypeError(e)},$=(e,a,n,h)=>{for(var s=h>1?void 0:h?L(a,n):a,o=e.length-1,i;o>=0;o--)(i=e[o])&&(s=(h?i(a,n,s):i(s))||s);return h&&s&&B(a,n,s),s},E=(e,a,n)=>a.has(e)||A("Cannot "+n),P=(e,a,n)=>(E(e,a,"read from private field"),n?n.call(e):a.get(e)),C=(e,a,n)=>a.has(e)?A("Cannot add the same private member more than once"):a instanceof WeakSet?a.add(e):a.set(e,n),c=(e,a,n)=>(E(e,a,"access private method"),n),w,r,D,_,I,T,g;const U="forge-ai-floating-chat";let p=class extends F{constructor(){super(...arguments),C(this,r),this.open=!1,this.expanded=!1,this.label="AI Assistant",this._userExpanded=!1,C(this,w,H())}render(){return m`
      <forge-ai-dialog
        ${M(P(this,w))}
        ?open=${this.open}
    ...
    `}},u={},x={args:{open:!0},render:function(e){const a=o=>{t("forge-ai-disclaimer-agree")(o);const i=o.target?.closest("forge-ai-floating-chat"),l=i?.querySelector("forge-ai-disclaimer");if(l&&i){l.remove();const d=document.createElement("forge-ai-chatbot");d.setAttribute("show-minimize-button",""),i.appendChild(d)}},n=o=>{t("forge-ai-disclaimer-disagree")(o),o.target?.closest("forge-ai-floating-chat")?.close()},h=o=>{t("forge-ai-floating-chat-expand")(o);const i=o.target.querySelector("forge-ai-chatbot");i&&(i.expanded=!0)},s=o=>{t("forge-ai-floating-chat-collapse")(o);const i=o.target.querySelector("forge-ai-chatbot");i&&(i.expanded=!1)};return m`
      <div style="min-height: 300px;">
        <div>
      ...
      <div style="min-height: 300px;">
        ...
        <forge-ai-floating-chat
          ...
          <forge-ai-chatbot
            ...
            @forge-ai-chatbot-clear=${t("forge-ai-chatbot-clear")}
            @forge-ai-chatbot-info=${t("forge-ai-chatbot-info")}
            @forge-ai-chatbot-thread-select=${f=>i(f.detail)}
    ...
    `}};u.parameters={...u.parameters,docs:{...u.parameters?.docs,source:{originalSource:"{}",...u.parameters?.docs?.source}}};x.parameters={...x.parameters,docs:{...x.parameters?.docs,source:{originalSource:`{
  args: {
    open: true
  },
...
}`,...v.parameters?.docs?.source}}};const Y=["Demo","WithDisclaimer","WithConversationHistory"],te=Object.freeze(Object.defineProperty({__proto__:null,Demo:u,WithConversationHistory:v,WithDisclaimer:x,__namedExportsOrder:Y,default:G},Symbol.toStringTag,{value:"Module"}));export{te as A};
