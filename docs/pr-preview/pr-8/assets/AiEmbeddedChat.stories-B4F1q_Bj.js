import{r as M,i as A,x as f}from"./iframe-DX3u0_W5.js";import{t as O}from"./custom-element-UsVr97OX.js";import{n as l}from"./property-D4agxrxF.js";import{r as T}from"./state-CO6Dtl_5.js";import{o as F}from"./if-defined-DYQbmY0q.js";import{n as S,e as D}from"./ai-modal-CnMxbxKV.js";import{n as I}from"./when-CI7b_ccM.js";import"./ai-chatbot-DzBafubj.js";import{M as U}from"./mock-adapter-CyWJDEYb.js";import"./ai-gradient-container-B1FcS6CP.js";const P=":host{display:block}.ai-embedded-chat{display:contents}";var V=Object.defineProperty,z=Object.getOwnPropertyDescriptor,x=e=>{throw TypeError(e)},d=(e,t,a,g)=>{for(var s=g>1?void 0:g?z(t,a):t,u=e.length-1,b;u>=0;u--)(b=e[u])&&(s=(g?b(t,a,s):b(s))||s);return g&&s&&V(t,a,s),s},$=(e,t,a)=>t.has(e)||x("Cannot "+a),c=(e,t,a)=>($(e,t,"read from private field"),a?a.call(e):t.get(e)),v=(e,t,a)=>t.has(e)?x("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,a),n=(e,t,a)=>($(e,t,"access private method"),a),p,o,_,y,C,w,E,m;const k="forge-ai-embedded-chat";let i=class extends A{constructor(){super(...arguments),v(this,o),this.expanded=!1,this.gradientVariant="medium",this.fileUpload="off",this.placeholder="Ask a question...",this._isModalFullscreen=!1,v(this,p,D())}updated(){c(this,p).value&&this._isModalFullscreen!==c(this,p).value.fullscreen&&(this._isModalFullscreen=c(this,p).value.fullscreen??!1)}render(){return f`
      ${I(this.expanded,()=>f`
          <forge-ai-modal
            ${S(c(this,p))}
            ?open=${this.expanded}
