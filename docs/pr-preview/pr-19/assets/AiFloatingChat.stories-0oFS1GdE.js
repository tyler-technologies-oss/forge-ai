import{r as w,i as A,x as g}from"./iframe-jiECFzia.js";import{t as O}from"./custom-element-UsVr97OX.js";import{n as _}from"./property-ClszgVLm.js";import{r as S}from"./state-B_csnfW2.js";import{n as F,e as T}from"./ref-D_ywKXfr.js";import"./ai-dialog-BfLuJvTY.js";import"./ai-fab-DeKG0Xhc.js";import{M as D}from"./mock-adapter-Dat2lqqN.js";const M=":host{display:block}";var z=Object.defineProperty,P=Object.getOwnPropertyDescriptor,b=e=>{throw TypeError(e)},m=(e,t,o,c)=>{for(var l=c>1?void 0:c?P(t,o):t,p=e.length-1,s;p>=0;p--)(s=e[p])&&(l=(c?s(t,o,l):s(l))||l);return c&&l&&z(t,o,l),l},v=(e,t,o)=>t.has(e)||b("Cannot "+o),I=(e,t,o)=>(v(e,t,"read from private field"),o?o.call(e):t.get(e)),u=(e,t,o)=>t.has(e)?b("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,o),i=(e,t,o)=>(v(e,t,"access private method"),o),x,a,$,y,C,E,r;const k="forge-ai-floating-chat";let h=class extends A{constructor(){super(...arguments),u(this,a),this.open=!1,this.expanded=!1,this._userExpanded=!1,u(this,x,T())}render(){return g`
      <forge-ai-dialog
        ${F(I(this,x))}
        ?open=${this.open}
