import{x as d}from"./iframe-BhT7icML.js";import{I as p,c,d as l,e as f,f as g,g as m,h,i as u}from"./icon-registry-D8cCWsde.js";import{d as y,a as b}from"./ai-sidebar-DzldxaTl.js";import"./ai-chat-interface-DL1Prrnn.js";import"./ai-prompt-CehxtmSE.js";import"./ai-chat-header-CRkx08o0.js";import"./ai-user-message-1DcjgWIr.js";import"./ai-response-message-8XpzMy9w.js";import"./ai-button-BGFdkr1r.js";import{d as I}from"./index-CW8yr7p-.js";const{action:r}=__STORYBOOK_MODULE_ACTIONS__;y();b();I();p.define([c,l,f,g,m,h,u]);const w="forge-ai-sidebar",x={title:"AI Components/Primitives/Sidebar",component:w,argTypes:{open:{control:{type:"boolean"},description:"Controls whether the sidebar is open"},expanded:{control:{type:"boolean"},description:"Controls whether the sidebar is displayed in an expanded state"}},args:{open:!1,expanded:!1},render:a=>{const t=r("forge-ai-sidebar-open"),i=r("forge-ai-sidebar-close"),s=()=>{const e=document.querySelector("forge-ai-chat-interface");e&&(e.expanded=!e.expanded)},n=()=>{document.querySelector("forge-ai-sidebar")?.close()};return d`
