import{x as h}from"./iframe-4E2mj6Mt.js";import"./ai-chatbot-CE6tKHoX.js";import"./ai-message-thread-CGeuZFWU.js";import"./utils-C_XXmvvR.js";import"./ai-empty-state-DXIydU-Z.js";import"./ai-suggestions-C_yg7vcg.js";import"./ai-voice-input-B-Cd2Hdn.js";import{M as g}from"./mock-adapter-MuFwfiLK.js";const{action:t}=__STORYBOOK_MODULE_ACTIONS__,v="forge-ai-chatbot",w={title:"AI Components/Primitives/Chatbot",component:v,argTypes:{placeholder:{control:"text",description:"Placeholder text for the input field"},title:{control:"text",description:"Custom title for the chatbot header"},fileUpload:{control:"select",options:["on","off"],description:"Enable file upload functionality"},voiceInput:{control:"select",options:["on","off"],description:"Enable voice input functionality"},showExpandButton:{control:"boolean",description:"Show expand button in header"},showMinimizeButton:{control:"boolean",description:"Show minimize button in header"},expanded:{control:"boolean",description:"Expanded state (affects icon display)"},minimizeIcon:{control:"select",options:["default","panel"],description:"Minimize icon variant"},enableReactions:{control:"boolean",description:"Enable thumbs up/down reaction buttons"}},args:{placeholder:"Ask a question...",title:"AI Assistant",fileUpload:"off",voiceInput:"on",showExpandButton:!1,showMinimizeButton:!1,expanded:!1,minimizeIcon:"default",enableReactions:!1},render:e=>{const n=new g({simulateStreaming:!0,simulateTools:!1,streamingDelay:50,responseDelay:500}),i=t("forge-ai-chatbot-connected"),r=t("forge-ai-chatbot-disconnected"),o=t("forge-ai-chatbot-message-sent"),p=t("forge-ai-chatbot-message-received"),a=t("forge-ai-chatbot-tool-call"),m=t("forge-ai-chatbot-error"),u=t("forge-ai-chatbot-expand"),b=t("forge-ai-chatbot-minimize"),f=t("forge-ai-chatbot-clear"),$=t("forge-ai-chatbot-export"),x=t("forge-ai-chatbot-info");return h`
