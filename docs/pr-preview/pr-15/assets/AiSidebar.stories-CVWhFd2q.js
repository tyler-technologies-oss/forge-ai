import{x as d}from"./iframe-BP-zW2Td.js";import{I as p,c,d as l,e as f,f as g,g as m,h,i as u}from"./icon-registry-D8cCWsde.js";import{d as y,a as b}from"./ai-sidebar-Cj_6eiap.js";import"./ai-chat-interface-pHJs0hV_.js";import"./ai-prompt-Cx4CZIXH.js";import"./ai-chat-header-AKsdlmuj.js";import"./ai-user-message-29aM79z7.js";import"./ai-response-message-CVtnP0Ju.js";import"./ai-button-BGhf_Q1A.js";import{d as I}from"./index-DgBXuBpu.js";const{action:r}=__STORYBOOK_MODULE_ACTIONS__;y();b();I();p.define([c,l,f,g,m,h,u]);const w="forge-ai-sidebar",x={title:"AI Components/Primitives/Sidebar",component:w,argTypes:{open:{control:{type:"boolean"},description:"Controls whether the sidebar is open"},expanded:{control:{type:"boolean"},description:"Controls whether the sidebar is displayed in an expanded state"}},args:{open:!1,expanded:!1},render:a=>{const t=r("forge-ai-sidebar-open"),i=r("forge-ai-sidebar-close"),s=()=>{const e=document.querySelector("forge-ai-chat-interface");e&&(e.expanded=!e.expanded)},n=()=>{document.querySelector("forge-ai-sidebar")?.close()};return d`
