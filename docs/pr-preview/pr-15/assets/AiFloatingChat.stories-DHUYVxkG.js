import{r as A,i as E,x as g}from"./iframe-CRcLxRdn.js";import{t as O}from"./custom-element-UsVr97OX.js";import{n as b}from"./property-DWmMKgh8.js";import{n as S,e as F}from"./ref-eOfpKTvc.js";import"./ai-dialog-BqH7UaxF.js";import"./ai-fab-CfGdTZwJ.js";import{M as T}from"./mock-adapter-MuFwfiLK.js";const D=":host{display:block}";var M=Object.defineProperty,z=Object.getOwnPropertyDescriptor,_=e=>{throw TypeError(e)},x=(e,t,o,c)=>{for(var l=c>1?void 0:c?z(t,o):t,h=e.length-1,s;h>=0;h--)(s=e[h])&&(l=(c?s(t,o,l):s(l))||l);return c&&l&&M(t,o,l),l},v=(e,t,o)=>t.has(e)||_("Cannot "+o),P=(e,t,o)=>(v(e,t,"read from private field"),o?o.call(e):t.get(e)),u=(e,t,o)=>t.has(e)?_("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,o),i=(e,t,o)=>(v(e,t,"access private method"),o),m,a,$,y,C,w,r;const I="forge-ai-floating-chat";let d=class extends E{constructor(){super(...arguments),u(this,a),this.open=!1,this.expanded=!1,u(this,m,F())}render(){return g`
      <forge-ai-dialog
        ${S(P(this,m))}
        ?open=${this.open}
