import{r as q,i as P,x as p}from"./iframe-D5E-uNG9.js";import{d as W,T as B,I as L,j as F,k as H,l as R,m as U,n as N,o as Y,p as V}from"./split-button-DrMf-JT7.js";import{d as j,a as G}from"./ai-sidebar-D9c7hedi.js";import{d as K}from"./index-ChMCOsCN.js";import{t as J}from"./custom-element-UsVr97OX.js";import{n as S}from"./property-CdeMDwTb.js";import{n as w,e as _}from"./ref-B_pzrLtq.js";import{n as Q}from"./when-CI7b_ccM.js";import"./ai-modal-CTKMOMgH.js";import"./ai-button-DT6tFmfF.js";import"./ai-disclaimer-C_o26gMM.js";import{M as X}from"./mock-adapter-uhjSnHDA.js";function Z(){W(B)}const ee=":host{display:block;height:100%}";var ae=Object.defineProperty,te=Object.getOwnPropertyDescriptor,E=e=>{throw TypeError(e)},$=(e,a,s,h)=>{for(var d=h>1?void 0:h?te(a,s):a,n=e.length-1,t;n>=0;n--)(t=e[n])&&(d=(h?t(a,s,d):t(d))||d);return h&&d&&ae(a,s,d),d},I=(e,a,s)=>a.has(e)||E("Cannot "+s),m=(e,a,s)=>(I(e,a,"read from private field"),s?s.call(e):a.get(e)),u=(e,a,s)=>a.has(e)?E("Cannot add the same private member more than once"):a instanceof WeakSet?a.add(e):a.set(e,s),r=(e,a,s)=>(I(e,a,"access private method"),s),x,v,y,o,T,D,k,M,z,O,c;const oe="forge-ai-sidebar-chat";let b=class extends P{constructor(){super(...arguments),u(this,o),this.open=!1,this.expanded=!1,u(this,x,_()),u(this,v,_()),u(this,y,p`
    <slot
      @forge-ai-chatbot-expand=${r(this,o,M)}
      @forge-ai-chatbot-minimize=${r(this,o,z)}></slot>
  `)}render(){return p`
      ${Q(this.expanded,()=>p`
          <forge-ai-modal
            ${w(m(this,v))}
            ?open=${this.open&&this.expanded}
            @forge-ai-modal-fullscreen-change=${r(this,o,k)}
            @forge-ai-modal-close=${r(this,o,O)}>
            ${m(this,y)}
          </forge-ai-modal>
        `,()=>p`
          <forge-ai-sidebar
