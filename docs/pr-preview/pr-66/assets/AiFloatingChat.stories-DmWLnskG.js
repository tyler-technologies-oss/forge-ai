import{r as M,i as F,x as g}from"./iframe-GE7whtSK.js";import{t as q}from"./custom-element-UsVr97OX.js";import{n as C}from"./property-03qbO25n.js";import{r as k}from"./base-Df1FQLg5.js";import{n as I,e as O}from"./ref-DIcpijIK.js";import"./ai-dialog-qLlXDfTZ.js";import"./ai-fab-CrGiSQwA.js";import"./ai-disclaimer-61UgjCZW.js";import{M as E}from"./mock-adapter-uhjSnHDA.js";const H=":host{display:block}::slotted(forge-ai-chatbot){border-radius:calc(var(--forge-shape-large, 8px) * var(--forge-shape-factor, 1))}";var W=Object.defineProperty,B=Object.getOwnPropertyDescriptor,S=e=>{throw TypeError(e)},$=(e,a,i,l)=>{for(var s=l>1?void 0:l?B(a,i):a,n=e.length-1,o;n>=0;n--)(o=e[n])&&(s=(l?o(a,i,s):o(s))||s);return l&&s&&W(a,i,s),s},D=(e,a,i)=>a.has(e)||S("Cannot "+i),P=(e,a,i)=>(D(e,a,"read from private field"),i?i.call(e):a.get(e)),y=(e,a,i)=>a.has(e)?S("Cannot add the same private member more than once"):a instanceof WeakSet?a.add(e):a.set(e,i),c=(e,a,i)=>(D(e,a,"access private method"),i),w,r,_,A,T,z,d;const L="forge-ai-floating-chat";let p=class extends F{constructor(){super(...arguments),y(this,r),this.open=!1,this.expanded=!1,this._userExpanded=!1,y(this,w,O())}render(){return g`
      <forge-ai-dialog
        ${I(P(this,w))}
        ?open=${this.open}
        ?expanded=${this.expanded}
        @forge-ai-dialog-fullscreen-change=${c(this,r,_)}
        @forge-ai-dialog-close=${c(this,r,z)}>
        <slot
          @forge-ai-chatbot-expand=${c(this,r,A)}
          @forge-ai-chatbot-minimize=${c(this,r,T)}></slot>
      </forge-ai-dialog>
    `}show(){this.open=!0,c(this,r,d).call(this,"forge-ai-floating-chat-open")}close(){this.expanded&&(this.expanded=!1,c(this,r,d).call(this,"forge-ai-floating-chat-collapse")),this.open=!1,c(this,r,d).call(this,"forge-ai-floating-chat-close")}toggle(){this.open?this.close():this.show()}expand(){this.expanded||(this.expanded=!0,this._userExpanded=!0,c(this,r,d).call(this,"forge-ai-floating-chat-expand"))}collapse(){this.expanded&&(this.expanded=!1,this._userExpanded=!1,c(this,r,d).call(this,"forge-ai-floating-chat-collapse"))}};w=new WeakMap;r=new WeakSet;_=function(e){const{isFullscreen:a}=e.detail;a&&!this.expanded?(this.expanded=!0,c(this,r,d).call(this,"forge-ai-floating-chat-expand")):!a&&this.expanded&&!this._userExpanded&&(this.expanded=!1,c(this,r,d).call(this,"forge-ai-floating-chat-collapse"))};A=function(){this.expanded=!this.expanded,this._userExpanded=this.expanded,this.expanded?c(this,r,d).call(this,"forge-ai-floating-chat-expand"):c(this,r,d).call(this,"forge-ai-floating-chat-collapse")};T=function(){this.close()};z=function(){this.open&&this.close()};d=function(e){const a=new CustomEvent(e,{bubbles:!0,composed:!0});this.dispatchEvent(a)};p.styles=M(H);$([C({type:Boolean})],p.prototype,"open",2);$([C({type:Boolean})],p.prototype,"expanded",2);$([k()],p.prototype,"_userExpanded",2);p=$([q(L)],p);const{action:t}=__STORYBOOK_MODULE_ACTIONS__,Y="forge-ai-floating-chat",U={title:"AI Components/Form Factors/Floating",component:Y,argTypes:{adapter:{control:!1,description:"The adapter for communication with the AI service"},open:{control:{type:"boolean"},description:"Controls whether the chat is open"},expanded:{control:{type:"boolean"},description:"Controls whether the chat is displayed in an expanded state"},fileUpload:{control:{type:"select"},options:["on","off"],description:"Enable file upload functionality"},placeholder:{control:"text",description:"Placeholder text for input"}},args:{open:!1,expanded:!1,fileUpload:"off",placeholder:"Ask a question..."},render:e=>{const a=new E({simulateStreaming:!0,simulateTools:!1,streamingDelay:50,responseDelay:500}),i=o=>{t("forge-ai-floating-chat-expand")(o);const h=o.target.querySelector("forge-ai-chatbot");h&&(h.expanded=!0)},l=o=>{t("forge-ai-floating-chat-collapse")(o);const h=o.target.querySelector("forge-ai-chatbot");h&&(h.expanded=!1)},s=g`
      ...
      <div style="min-height: 300px;">
        ...
        <forge-ai-floating-chat
          ...
          <forge-ai-chatbot
            ...
            @forge-ai-chatbot-clear=${t("forge-ai-chatbot-clear")}
            @forge-ai-chatbot-info=${t("forge-ai-chatbot-info")}
            @forge-ai-chatbot-conversation-select=${f=>n(f.detail)}
