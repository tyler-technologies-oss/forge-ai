import{x as p}from"./iframe-DcAZW8iy.js";import"./ai-conversations-panel-DJQwbpZ6.js";import"./preload-helper-PPVm8Dsz.js";import"./custom-element-UsVr97OX.js";import"./property-Ckz5hMyx.js";import"./base-BoTOs8pR.js";import"./class-map-CbcegUi9.js";import"./when-CI7b_ccM.js";import"./ai-icon-DRkMzXgZ.js";import"./utils-BGBq21po.js";import"./ai-gradient-container--FWSrnqp.js";import"./ai-spinner-D6NUSPNm.js";import"./ai-dropdown-menu-Cnn7XMAl.js";import"./query-assigned-elements-BaCIf_t7.js";import"./if-defined-gZBbtPMx.js";import"./popover-CeHIk7Gj.js";import"./overlay-CbmlEmpq.js";import"./floating-ui.dom-C0FiGihr.js";import"./query-assigned-nodes-Ba5g_8kl.js";import"./ai-dropdown-menu-item-Dpxybdz_.js";const{action:e}=__STORYBOOK_MODULE_ACTIONS__,S="forge-ai-conversations-panel",D=(n,r=0)=>{const s=["TypeScript","Web Components","React","Angular","Vue","CSS Grid","Flexbox","JavaScript","Performance","Testing"],a=["best practices","tutorial","comparison","explained","patterns","optimization","debugging"];return Array.from({length:n},(i,l)=>{const o=r+l,t=s[o%s.length],d=a[Math.floor(o/s.length)%a.length],c=Math.floor(o/5)+1;return{id:`thread-${o+1}`,title:`${t} ${d}`,time:c===1?"Yesterday":`${c} days ago`,date:new Date(Date.now()-c*24*60*60*1e3)}})},h=[{id:"thread-1",title:"TypeScript best practices",time:"2:30 PM",date:new Date(Date.now()-7200*1e3)},{id:"thread-2",title:"Web component architecture",time:"11:45 AM",date:new Date(Date.now()-300*60*1e3)},{id:"thread-3",title:"How to use localStorage?",time:"Yesterday",date:new Date(Date.now()-1440*60*1e3)},{id:"thread-4",title:"Lit reactive controllers explained",time:"Yesterday",date:new Date(Date.now()-2160*60*1e3)},{id:"thread-5",title:"CSS Grid vs Flexbox comparison",time:"2 days ago",date:new Date(Date.now()-2880*60*1e3)},{id:"thread-6",title:"JavaScript async/await patterns",time:"3 days ago",date:new Date(Date.now()-4320*60*1e3)},{id:"thread-7",title:"React hooks vs Lit reactive properties",time:"4 days ago",date:new Date(Date.now()-5760*60*1e3)},{id:"thread-8",title:"Testing web components",time:"5 days ago",date:new Date(Date.now()-7200*60*1e3)}],Y={title:"AI Components/Primitives/Conversations Panel",component:S,argTypes:{recentThreads:{control:"object",description:"Array of recent conversation threads to display"},selectedThreadId:{control:"text",description:"ID of the currently selected thread"},showConversationRename:{control:"boolean",description:"Show rename option in conversations panel"},showConversationDelete:{control:"boolean",description:"Show delete option in conversations panel"}},args:{recentThreads:h,selectedThreadId:null,showConversationRename:!0,showConversationDelete:!0},render:n=>p`
