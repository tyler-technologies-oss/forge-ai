import{r as L,i as B,x as f}from"./iframe-Bzg3eSx7.js";import{f as Y,T as F,I as N,l as U,e as R,m as G,n as V,o as K,p as j,q as J}from"./split-button-B26_2k-S.js";import{d as Q,a as X}from"./ai-sidebar-sXKsWq2z.js";import{d as Z}from"./index-DqAbOTzd.js";import{t as ee}from"./custom-element-UsVr97OX.js";import{n as T}from"./property-L1VQaxJ8.js";import{n as E,e as _}from"./ref-Cej_tsEZ.js";import{n as ae}from"./when-CI7b_ccM.js";import"./ai-modal-CCyElXqT.js";import"./ai-button-D_zNuqOO.js";import"./ai-disclaimer-BDalhom8.js";import{M as I}from"./mock-adapter-uhjSnHDA.js";function te(){Y(F)}const oe=":host{display:block;height:100%}";var re=Object.defineProperty,ie=Object.getOwnPropertyDescriptor,M=e=>{throw TypeError(e)},D=(e,t,i,h)=>{for(var c=h>1?void 0:h?ie(t,i):t,s=e.length-1,o;s>=0;s--)(o=e[s])&&(c=(h?o(t,i,c):o(c))||c);return h&&c&&re(t,i,c),c},k=(e,t,i)=>t.has(e)||M("Cannot "+i),$=(e,t,i)=>(k(e,t,"read from private field"),i?i.call(e):t.get(e)),w=(e,t,i)=>t.has(e)?M("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,i),n=(e,t,i)=>(k(e,t,"access private method"),i),S,A,C,r,q,z,O,P,W,H,l;const ne="forge-ai-sidebar-chat";let v=class extends B{constructor(){super(...arguments),w(this,r),this.open=!1,this.expanded=!1,w(this,S,_()),w(this,A,_()),w(this,C,f`
    <slot
