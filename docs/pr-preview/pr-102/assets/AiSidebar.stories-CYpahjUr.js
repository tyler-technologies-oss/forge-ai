import{x as d}from"./iframe-CdSABX88.js";import{I as p,l as c,a as l,m as f,n as m,o as g,p as h,q as u}from"./scaffold-B54ZsXy3.js";import"./split-button-BQD-qdRX.js";import{d as b,a as y}from"./ai-sidebar-CyJoxdxT.js";import{d as I}from"./index-Dsh4wFqr.js";import"./ai-chat-interface-CN9DBQ0v.js";import"./ai-prompt-CfRbJAhI.js";import"./ai-chat-header-M1-4hwpZ.js";import"./ai-user-message-CKYfvMZK.js";import"./ai-response-message-CkjBZD56.js";import"./ai-button-CTXeeLDY.js";const{action:r}=__STORYBOOK_MODULE_ACTIONS__;b();y();I();p.define([c,l,f,m,g,h,u]);const w="forge-ai-sidebar",x={title:"AI Components/Primitives/Sidebar",component:w,argTypes:{open:{control:{type:"boolean"},description:"Controls whether the sidebar is open"},expanded:{control:{type:"boolean"},description:"Controls whether the sidebar is displayed in an expanded state"},resizable:{control:{type:"boolean"},description:"Enables sidebar resizing"}},args:{open:!1,expanded:!1,resizable:!0},render:a=>{const t=r("forge-ai-sidebar-open"),i=r("forge-ai-sidebar-close"),s=()=>{const e=document.querySelector("forge-ai-chat-interface");e&&(e.expanded=!e.expanded)},n=()=>{document.querySelector("forge-ai-sidebar")?.close()};return d`
