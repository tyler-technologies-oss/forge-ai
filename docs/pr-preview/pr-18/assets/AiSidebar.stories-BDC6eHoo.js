import{x as d}from"./iframe-DjbbAuUw.js";import{I as p,c,d as l,e as f,f as g,g as m,h,i as u}from"./icon-registry-D8cCWsde.js";import{d as y,a as b}from"./ai-sidebar-D5xacMq4.js";import"./ai-chat-interface-CsOqOyvP.js";import"./ai-prompt-A3ZmUgOz.js";import"./ai-chat-header-BZA3Tsyw.js";import"./ai-user-message-qbAA-AwU.js";import"./ai-response-message-5sM5cCYp.js";import"./ai-button-DPFIvMwF.js";import{d as I}from"./index-ic4dnIs-.js";const{action:r}=__STORYBOOK_MODULE_ACTIONS__;y();b();I();p.define([c,l,f,g,m,h,u]);const w="forge-ai-sidebar",x={title:"AI Components/Primitives/Sidebar",component:w,argTypes:{open:{control:{type:"boolean"},description:"Controls whether the sidebar is open"},expanded:{control:{type:"boolean"},description:"Controls whether the sidebar is displayed in an expanded state"}},args:{open:!1,expanded:!1},render:a=>{const t=r("forge-ai-sidebar-open"),i=r("forge-ai-sidebar-close"),s=()=>{const e=document.querySelector("forge-ai-chat-interface");e&&(e.expanded=!e.expanded)},n=()=>{document.querySelector("forge-ai-sidebar")?.close()};return d`
