import{x as i}from"./iframe-Dx6l1SA4.js";import"./ai-attachment-B0KTFpAl.js";const{action:a}=__STORYBOOK_MODULE_ACTIONS__,n="forge-ai-attachment",m={title:"AI Components/Primitives/Attachment",render:e=>{const o=a("forge-ai-attachment-remove");return i`
      <forge-ai-attachment
        .filename=${e.filename}
        .size=${e.size}
        .mimeType=${e.mimeType}
