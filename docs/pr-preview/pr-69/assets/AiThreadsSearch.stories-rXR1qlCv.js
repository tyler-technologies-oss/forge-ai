import{x as C}from"./iframe-kWxAaNnO.js";import"./ai-threads-search-A_-X6Bzk.js";import"./ai-threads-CRCLQgSN.js";import"./preload-helper-PPVm8Dsz.js";import"./custom-element-UsVr97OX.js";import"./property-DbcC4dJO.js";import"./class-map-D3zHAmU4.js";import"./when-CI7b_ccM.js";import"./ai-edit-thread-og_kxsaa.js";import"./ref-CTx8O7Q5.js";import"./ai-dropdown-menu-CZ0aH5Mt.js";import"./query-assigned-nodes-DcRlMnjx.js";import"./if-defined-BHQZvS4G.js";import"./popover-D3yAdZNC.js";import"./overlay-lt7Sht5C.js";import"./floating-ui.dom-C0FiGihr.js";import"./utils-BGBq21po.js";import"./ai-dropdown-menu-item-CcDrtPbJ.js";import"./ai-spinner-BgHNNbxq.js";import"./ai-modal-BzQHxPn1.js";import"./ai-icon-Vo3xH-hs.js";import"./ai-gradient-container-CVwZZtJm.js";const{action:e}=__STORYBOOK_MODULE_ACTIONS__,t=(r,a=0)=>{const s=["Getting Started with AI","Data Analysis Question","Code Review Discussion","Project Planning","Bug Investigation","Feature Development"];return Array.from({length:r},(o,n)=>({id:`thread-${a+n+1}`,title:`${s[n%s.length]}`,createdAt:new Date(Date.now()-(n+a)*864e5).toISOString(),messageCount:Math.floor(Math.random()*20)+1}))},R="forge-ai-threads-search",H={title:"AI Components/Primitives/Threads Search",component:R,argTypes:{threads:{control:"object",description:"Array of threads to display"},totalChats:{control:{type:"number"},description:"Total number of chats available for pagination. Set to 0 to disable infinite scroll."},showNewChat:{control:"boolean",description:'Show "New chat" button in header'},showThreadRename:{control:"boolean",description:"Show rename action in thread menu"},showThreadDelete:{control:"boolean",description:"Show delete action in thread menu"},placeholder:{control:"text",description:"Placeholder text for search input"},emptyMessage:{control:"text",description:"Message displayed when no results found"}},args:{threads:t(10),totalChats:0,showNewChat:!0,placeholder:"Search conversations...",emptyMessage:"No conversations found"},render:r=>C`
...
}`,...y.parameters?.docs?.source}}};const J=["Demo","WithLocalSearch","WithAsyncSearch","WithInfiniteScroll","EmptyState","WithoutNewChatButton","InThreadsContext","WithRenameAndDelete","WithRenameOnly","WithDeleteOnly"];export{i as Demo,m as EmptyState,w as InThreadsContext,g as WithAsyncSearch,y as WithDeleteOnly,u as WithInfiniteScroll,l as WithLocalSearch,p as WithRenameAndDelete,$ as WithRenameOnly,f as WithoutNewChatButton,J as __namedExportsOrder,H as default};
