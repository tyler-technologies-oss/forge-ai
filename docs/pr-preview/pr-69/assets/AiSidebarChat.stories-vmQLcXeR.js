import{r as L,i as B,x as f}from"./iframe-kWxAaNnO.js";import{f as F,T as N,I as U,l as R,a as G,m as Y,n as V,o as K,p as j,q as J}from"./scaffold-xnr01x7B.js";import"./split-button-CJGX4ZiL.js";import{d as Q,a as X}from"./ai-sidebar-C1AEPwuw.js";import{d as Z}from"./index-BbF38XDo.js";import{t as ee}from"./custom-element-UsVr97OX.js";import{n as _}from"./property-DbcC4dJO.js";import{n as I,e as E}from"./ref-CTx8O7Q5.js";import{n as ae}from"./when-CI7b_ccM.js";import"./ai-modal-BzQHxPn1.js";import"./ai-button-CVeeuXL9.js";import"./ai-disclaimer-Dp9Psa_k.js";import{M as T}from"./mock-adapter-uhjSnHDA.js";function te(){F(N)}const oe=":host{display:block;height:100%}";var re=Object.defineProperty,ie=Object.getOwnPropertyDescriptor,O=e=>{throw TypeError(e)},D=(e,t,i,h)=>{for(var c=h>1?void 0:h?ie(t,i):t,s=e.length-1,o;s>=0;s--)(o=e[s])&&(c=(h?o(t,i,c):o(c))||c);return h&&c&&re(t,i,c),c},k=(e,t,i)=>t.has(e)||O("Cannot "+i),$=(e,t,i)=>(k(e,t,"read from private field"),i?i.call(e):t.get(e)),w=(e,t,i)=>t.has(e)?O("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,i),n=(e,t,i)=>(k(e,t,"access private method"),i),S,A,C,r,M,q,z,P,W,H,l;const ne="forge-ai-sidebar-chat";let v=class extends B{constructor(){super(...arguments),w(this,r),this.open=!1,this.expanded=!1,w(this,S,E()),w(this,A,E()),w(this,C,f`
    <slot
  ...
  `)}render(){return f`
      ${ae(this.expanded,()=>f`
          <forge-ai-modal
            ...
            @forge-ai-modal-fullscreen-change=${n(this,r,z)}
    ...
    `}},u={args:{open:!0},render:function(e){const t=new T({simulateStreaming:!0,simulateTools:!1,streamingDelay:50,responseDelay:500}),i=[{id:"thread-1",title:"TypeScript best practices",createdAt:new Date(Date.now()-7200*1e3).toISOString(),messageCount:8},{id:"thread-2",title:"Web component architecture",createdAt:new Date(Date.now()-300*60*1e3).toISOString(),messageCount:15},{id:"thread-3",title:"How to use localStorage?",createdAt:new Date(Date.now()-1440*60*1e3).toISOString(),messageCount:3},{id:"thread-4",title:"Lit reactive controllers explained",createdAt:new Date(Date.now()-2160*60*1e3).toISOString(),messageCount:12},{id:"thread-5",title:"CSS Grid vs Flexbox comparison",createdAt:new Date(Date.now()-2880*60*1e3).toISOString(),messageCount:6}],h=g=>{a("forge-ai-sidebar-chat-expand")(g);const p=g.target.querySelector("forge-ai-chatbot");p&&(p.expanded=!0)},c=g=>{a("forge-ai-sidebar-chat-collapse")(g);const p=g.target.querySelector("forge-ai-chatbot");p&&(p.expanded=!1)},s=a("forge-ai-chatbot-conversation-select"),o=a("forge-ai-chatbot-new-chat"),d=a("forge-ai-chatbot-conversations-open"),y=a("forge-ai-chatbot-conversations-close"),x=f`
      <forge-ai-sidebar-chat
        ...
        <forge-ai-chatbot
          ...
          @forge-ai-chatbot-clear=${a("forge-ai-chatbot-clear")}
          @forge-ai-chatbot-info=${a("forge-ai-chatbot-info")}
          @forge-ai-chatbot-conversation-select=${g=>s(g.detail)}
...
}`,...u.parameters?.docs?.source}}};const de=["Demo","WithDisclaimer","WithConversationHistory"],Ce=Object.freeze(Object.defineProperty({__proto__:null,Demo:b,WithConversationHistory:u,WithDisclaimer:m,__namedExportsOrder:de,default:ce},Symbol.toStringTag,{value:"Module"}));export{Ce as A};
