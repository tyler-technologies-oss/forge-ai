import{x as v}from"./iframe-DmoIR2iB.js";import"./ai-conversations-panel-BqBCBEwj.js";import"./preload-helper-PPVm8Dsz.js";import"./custom-element-UsVr97OX.js";import"./property-D6A382qA.js";import"./class-map-BU13AwkM.js";import"./when-CI7b_ccM.js";import"./ai-edit-thread-CAmQIgA4.js";import"./ref-B-kmAuE0.js";import"./ai-dropdown-menu-DBsz8DKj.js";import"./query-assigned-nodes-C7uSgWhl.js";import"./if-defined-CFWMlw21.js";import"./popover-BOZz6asb.js";import"./overlay-ClAHEkU0.js";import"./floating-ui.dom-C0FiGihr.js";import"./utils-BGBq21po.js";import"./ai-dropdown-menu-item-B8BoH0oJ.js";import"./ai-modal-D6OyedAn.js";import"./ai-icon-3I7GOKyv.js";import"./ai-gradient-container-C3K8sgUk.js";import"./ai-spinner-DAZ1JxI9.js";const{action:e}=__STORYBOOK_MODULE_ACTIONS__,I="forge-ai-conversations-panel",y=(n,o=0)=>{const r=["TypeScript","Web Components","React","Angular","Vue","CSS Grid","Flexbox","JavaScript","Performance","Testing"],t=["best practices","tutorial","comparison","explained","patterns","optimization","debugging"];return Array.from({length:n},(s,i)=>{const a=o+i,l=r[a%r.length],c=t[Math.floor(a/r.length)%t.length],d=Math.floor(a/5)+1,h=Math.floor(Math.random()*20)+1;return{id:`thread-${a+1}`,title:`${l} ${c}`,createdAt:new Date(Date.now()-d*24*60*60*1e3).toISOString(),messageCount:h}})},$=[{id:"thread-1",title:"TypeScript best practices",createdAt:new Date(Date.now()-7200*1e3).toISOString(),messageCount:8},{id:"thread-2",title:"Web component architecture",createdAt:new Date(Date.now()-300*60*1e3).toISOString(),messageCount:15},{id:"thread-3",title:"How to use localStorage?",createdAt:new Date(Date.now()-1440*60*1e3).toISOString(),messageCount:3},{id:"thread-4",title:"Lit reactive controllers explained",createdAt:new Date(Date.now()-2160*60*1e3).toISOString(),messageCount:12},{id:"thread-5",title:"CSS Grid vs Flexbox comparison",createdAt:new Date(Date.now()-2880*60*1e3).toISOString(),messageCount:6},{id:"thread-6",title:"JavaScript async/await patterns",createdAt:new Date(Date.now()-4320*60*1e3).toISOString(),messageCount:9},{id:"thread-7",title:"React hooks vs Lit reactive properties",createdAt:new Date(Date.now()-5760*60*1e3).toISOString(),messageCount:7},{id:"thread-8",title:"Testing web components",createdAt:new Date(Date.now()-7200*60*1e3).toISOString(),messageCount:11}],U={title:"AI Components/Primitives/Conversations Panel",component:I,argTypes:{recentThreads:{control:"object",description:"Array of recent conversation threads to display"},selectedThreadId:{control:"text",description:"ID of the currently selected thread"},showConversationRename:{control:"boolean",description:"Show rename option in conversations panel"},showConversationDelete:{control:"boolean",description:"Show delete option in conversations panel"}},args:{recentThreads:$,selectedThreadId:null,showConversationRename:!0,showConversationDelete:!0},render:n=>v`
    ...
    `},m={},f={args:{selectedThreadId:"thread-2"}},u={args:{recentThreads:[]}},w={args:{recentThreads:$},render:n=>v`
      <div style="width: 400px; height: 600px; border: 1px solid var(--forge-theme-outline);">
        <forge-ai-conversations-panel
          ...
          @forge-ai-conversations-panel-new-chat=${e("forge-ai-conversations-panel-new-chat")}
          @forge-ai-conversations-panel-close=${e("forge-ai-conversations-panel-close")}
          @forge-ai-conversations-panel-search=${o=>{e("forge-ai-conversations-panel-search")(o)}}
          @forge-ai-conversations-panel-rename=${e("forge-ai-conversations-panel-rename")}
          @forge-ai-conversations-panel-delete=${e("forge-ai-conversations-panel-delete")}>
        </forge-ai-conversations-panel>
      </div>
    ...
    `},S={args:{recentThreads:$},render:n=>{const o=[...$,{id:"thread-9",title:"Advanced TypeScript generics tutorial",createdAt:new Date(Date.now()-6048e5).toISOString(),messageCount:18},{id:"thread-10",title:"Building custom Lit directives",createdAt:new Date(Date.now()-6912e5).toISOString(),messageCount:5},{id:"thread-11",title:"TypeScript utility types explained",createdAt:new Date(Date.now()-12096e5).toISOString(),messageCount:14},{id:"thread-12",title:"Performance optimization techniques",createdAt:new Date(Date.now()-1296e6).toISOString(),messageCount:22}],r=t=>{e("forge-ai-conversations-panel-search")(t),t.preventDefault();const{query:s,setResults:i}=t.detail;setTimeout(()=>{const a=o.filter(l=>l.title.toLowerCase().includes(s.toLowerCase()));i(a)},1e3)};return v`
      <div style="width: 400px; height: 600px; border: 1px solid var(--forge-theme-outline);">
        <forge-ai-conversations-panel
          .recentThreads=${n.recentThreads}
          .selectedThreadId=${n.selectedThreadId}
    ...
    `}},T={args:{recentThreads:[]},render:n=>{const o=[{id:"thread-1",title:"Old conversation about TypeScript",createdAt:new Date(Date.now()-18144e5).toISOString(),messageCount:25},{id:"thread-2",title:"Archived discussion on web components",createdAt:new Date(Date.now()-2592e6).toISOString(),messageCount:19}],r=t=>{e("forge-ai-conversations-panel-search")(t),t.preventDefault();const{query:s,setResults:i}=t.detail;setTimeout(()=>{const a=o.filter(l=>l.title.toLowerCase().includes(s.toLowerCase()));i(a)},800)};return v`
      <div style="width: 400px; height: 600px; border: 1px solid var(--forge-theme-outline);">
        <forge-ai-conversations-panel
          .recentThreads=${n.recentThreads}
          .selectedThreadId=${n.selectedThreadId}
    ...
    `}},C={args:{recentThreads:y(20)},render:n=>{const t=y(120);let s=0,i=1;const a=c=>{e("forge-ai-conversations-panel-search")(c.detail),c.preventDefault();const{query:d,setResults:h}=c.detail;setTimeout(()=>{const p=t.filter(g=>g.title.toLowerCase().includes(d.toLowerCase()));h(p.slice(0,20)),s=0},500)},l=c=>{e("forge-ai-conversations-panel-load-more")(c.detail);const{query:d,appendResults:h}=c.detail;setTimeout(()=>{if(d===""){i++;const p=i*20,g=p+20,D=t.slice(p,g);h(D)}else{s++;const p=t.filter(A=>A.title.toLowerCase().includes(d.toLowerCase())),g=s*20,D=g+20,x=p.slice(g,D);h(x)}},500)};return v`
      <div style="width: 400px; height: 600px; border: 1px solid var(--forge-theme-outline);">
        <forge-ai-conversations-panel
          ...
          @forge-ai-conversations-panel-new-chat=${e("forge-ai-conversations-panel-new-chat")}
          @forge-ai-conversations-panel-close=${e("forge-ai-conversations-panel-close")}
          @forge-ai-conversations-panel-search=${a}
