import{x as v}from"./iframe-Bi-1nWkR.js";import"./ai-conversations-panel-DaZwpjH1.js";import"./preload-helper-PPVm8Dsz.js";import"./custom-element-UsVr97OX.js";import"./property-D-A3RxM9.js";import"./class-map-DveZVzB6.js";import"./when-CI7b_ccM.js";import"./ai-edit-thread-DyfjTsPy.js";import"./ref-CVnE5sLo.js";import"./ai-dropdown-menu-Cg8aOUr3.js";import"./query-assigned-nodes-DDrXrDde.js";import"./if-defined-bUPqGoPe.js";import"./popover-DJM4l3dC.js";import"./overlay-XfBHk16S.js";import"./floating-ui.dom-CHtvoTQ1.js";import"./utils-DIqd7FWX.js";import"./ai-dropdown-menu-item-D-LARChW.js";import"./ai-modal-_MO_XFb_.js";import"./ai-icon-DYcDW-Aq.js";import"./ai-gradient-container-DgMkJLwY.js";import"./ai-spinner-B4hfIXY7.js";const{action:e}=__STORYBOOK_MODULE_ACTIONS__,b="forge-ai-conversations-panel",A=(t,n=0)=>{const o=["TypeScript","Web Components","React","Angular","Vue","CSS Grid","Flexbox","JavaScript","Performance","Testing"],a=["best practices","tutorial","comparison","explained","patterns","optimization","debugging"];return Array.from({length:t},(s,i)=>{const r=n+i,l=o[r%o.length],c=a[Math.floor(r/o.length)%a.length],d=Math.floor(r/5)+1,h=Math.floor(Math.random()*20)+1;return{id:`thread-${r+1}`,title:`${l} ${c}`,createdAt:new Date(Date.now()-d*24*60*60*1e3).toISOString(),messageCount:h}})},y=[{id:"thread-1",title:"TypeScript best practices",createdAt:new Date(Date.now()-7200*1e3).toISOString(),messageCount:8},{id:"thread-2",title:"Web component architecture",createdAt:new Date(Date.now()-300*60*1e3).toISOString(),messageCount:15},{id:"thread-3",title:"How to use localStorage?",createdAt:new Date(Date.now()-1440*60*1e3).toISOString(),messageCount:3},{id:"thread-4",title:"Lit reactive controllers explained",createdAt:new Date(Date.now()-2160*60*1e3).toISOString(),messageCount:12},{id:"thread-5",title:"CSS Grid vs Flexbox comparison",createdAt:new Date(Date.now()-2880*60*1e3).toISOString(),messageCount:6},{id:"thread-6",title:"JavaScript async/await patterns",createdAt:new Date(Date.now()-4320*60*1e3).toISOString(),messageCount:9},{id:"thread-7",title:"React hooks vs Lit reactive properties",createdAt:new Date(Date.now()-5760*60*1e3).toISOString(),messageCount:7},{id:"thread-8",title:"Testing web components",createdAt:new Date(Date.now()-7200*60*1e3).toISOString(),messageCount:11}],V={title:"AI Components/Primitives/Conversations Panel",component:b,argTypes:{threads:{control:"object",description:"Array of recent conversation threads to display"},totalChats:{control:{type:"number"},description:"Total number of chats available for pagination. Set to 0 to disable infinite scroll."},selectedThreadId:{control:"text",description:"ID of the currently selected thread"},showThreadRename:{control:"boolean",description:"Show rename option in conversations panel"},showThreadDelete:{control:"boolean",description:"Show delete option in conversations panel"},loading:{control:"boolean",description:"Show a loading indicator in the recent chats list while threads are loading"}},args:{threads:y,totalChats:0,selectedThreadId:null,showThreadRename:!0,showThreadDelete:!0,loading:!1},render:t=>v`
      <div style="width: 400px; height: 600px; border: 1px solid var(--forge-theme-outline);">
        <forge-ai-conversations-panel
          ...
          @forge-ai-conversations-panel-load-more=${n=>{e("forge-ai-conversations-panel-load-more")(n),setTimeout(()=>{n.detail.appendResults([])},1e3)}}
    ...
    `},m={},u={args:{selectedThreadId:"thread-2"}},f={args:{threads:[]}},w={args:{threads:[],loading:!0}},S={args:{threads:y},render:t=>v`
      <div style="width: 400px; height: 600px; border: 1px solid var(--forge-theme-outline);">
        <forge-ai-conversations-panel
          .threads=${t.threads}
          .selectedThreadId=${t.selectedThreadId}
          ...
          @forge-ai-conversations-panel-new-chat=${e("forge-ai-conversations-panel-new-chat")}
          @forge-ai-conversations-panel-close=${e("forge-ai-conversations-panel-close")}
          @forge-ai-conversations-panel-search=${n=>{e("forge-ai-conversations-panel-search")(n)}}
          @forge-ai-conversations-panel-rename=${e("forge-ai-conversations-panel-rename")}
          @forge-ai-conversations-panel-delete=${e("forge-ai-conversations-panel-delete")}>
        </forge-ai-conversations-panel>
      </div>
    ...
    `},T={args:{threads:y},render:t=>{const n=[...y,{id:"thread-9",title:"Advanced TypeScript generics tutorial",createdAt:new Date(Date.now()-6048e5).toISOString(),messageCount:18},{id:"thread-10",title:"Building custom Lit directives",createdAt:new Date(Date.now()-6912e5).toISOString(),messageCount:5},{id:"thread-11",title:"TypeScript utility types explained",createdAt:new Date(Date.now()-12096e5).toISOString(),messageCount:14},{id:"thread-12",title:"Performance optimization techniques",createdAt:new Date(Date.now()-1296e6).toISOString(),messageCount:22}],o=a=>{e("forge-ai-conversations-panel-search")(a),a.preventDefault();const{query:s,setResults:i}=a.detail;setTimeout(()=>{const r=n.filter(l=>l.title.toLowerCase().includes(s.toLowerCase()));i(r)},1e3)};return v`
      <div style="width: 400px; height: 600px; border: 1px solid var(--forge-theme-outline);">
        <forge-ai-conversations-panel
          .threads=${t.threads}
          .selectedThreadId=${t.selectedThreadId}
    ...
    `}},$={args:{threads:[]},render:t=>{const n=[{id:"thread-1",title:"Old conversation about TypeScript",createdAt:new Date(Date.now()-18144e5).toISOString(),messageCount:25},{id:"thread-2",title:"Archived discussion on web components",createdAt:new Date(Date.now()-2592e6).toISOString(),messageCount:19}],o=a=>{e("forge-ai-conversations-panel-search")(a),a.preventDefault();const{query:s,setResults:i}=a.detail;setTimeout(()=>{const r=n.filter(l=>l.title.toLowerCase().includes(s.toLowerCase()));i(r)},800)};return v`
      <div style="width: 400px; height: 600px; border: 1px solid var(--forge-theme-outline);">
        <forge-ai-conversations-panel
          .threads=${t.threads}
          .selectedThreadId=${t.selectedThreadId}
    ...
    `}},D={args:{threads:A(20)},render:t=>{const a=A(120);let s=0,i=1;const r=c=>{e("forge-ai-conversations-panel-search")(c.detail),c.preventDefault();const{query:d,setResults:h}=c.detail;setTimeout(()=>{const p=a.filter(g=>g.title.toLowerCase().includes(d.toLowerCase()));h(p.slice(0,20)),s=0},500)},l=c=>{e("forge-ai-conversations-panel-load-more")(c.detail);const{query:d,appendResults:h}=c.detail;setTimeout(()=>{if(d===""){i++;const p=i*20,g=p+20,C=a.slice(p,g);h(C)}else{s++;const p=a.filter(I=>I.title.toLowerCase().includes(d.toLowerCase())),g=s*20,C=g+20,x=p.slice(g,C);h(x)}},500)};return v`
      <div style="width: 400px; height: 600px; border: 1px solid var(--forge-theme-outline);">
        <forge-ai-conversations-panel
          .threads=${t.threads}
          total-chats=${120}
...
}`,...D.parameters?.docs?.source}}};const Y=["Demo","WithSelectedThread","EmptyState","Loading","WithLocalSearch","WithAsyncSearch","WithNoRecentThreads","WithInfiniteScroll"];export{m as Demo,f as EmptyState,w as Loading,T as WithAsyncSearch,D as WithInfiniteScroll,S as WithLocalSearch,$ as WithNoRecentThreads,u as WithSelectedThread,Y as __namedExportsOrder,V as default};
