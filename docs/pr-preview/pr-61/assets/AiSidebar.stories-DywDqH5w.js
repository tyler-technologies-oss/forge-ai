import{x as d}from"./iframe-C4mdDn9Y.js";import{I as p,j as c,k as l,l as f,m,n as g,o as h,p as u}from"./split-button-CbMXHDu8.js";import{d as y,a as b}from"./ai-sidebar-Do9JUzSc.js";import{d as I}from"./index-B3CQufRl.js";import"./ai-chat-interface-A3waB8hB.js";import"./ai-prompt-1UcuVey0.js";import"./ai-chat-header-DqNLOugn.js";import"./ai-user-message-CwHEQlF7.js";import"./ai-response-message-P27eyLSE.js";import"./ai-button-DdcXOz5m.js";const{action:r}=__STORYBOOK_MODULE_ACTIONS__;y();b();I();p.define([c,l,f,m,g,h,u]);const w="forge-ai-sidebar",x={title:"AI Components/Primitives/Sidebar",component:w,argTypes:{open:{control:{type:"boolean"},description:"Controls whether the sidebar is open"},expanded:{control:{type:"boolean"},description:"Controls whether the sidebar is displayed in an expanded state"}},args:{open:!1,expanded:!1},render:a=>{const t=r("forge-ai-sidebar-open"),i=r("forge-ai-sidebar-close"),s=()=>{const e=document.querySelector("forge-ai-chat-interface");e&&(e.expanded=!e.expanded)},n=()=>{document.querySelector("forge-ai-sidebar")?.close()};return d`
