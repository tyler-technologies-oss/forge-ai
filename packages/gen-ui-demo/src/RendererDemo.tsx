...
import type { Spec, ComputedFunction } from './core';
import { SpecRenderer } from './lib/renderer';
...
const DEMO_SPEC: Spec = {
  ...
  elements: {
    ...
    // Alert with $cond for conditional variant
    'alert-section': {
      type: 'AlertBanner',
      props: {
    ...
    // Search with $bindState for two-way binding
    'search-section': {
      type: 'Grid',
      props: { columns: 1, gap: 'md' },
...
export const RendererDemo: FC = () => {
  ...
  return (
    <ForgeScaffold>
      <ForgeAppBar slot="header" titleText="Renderer Demo">
