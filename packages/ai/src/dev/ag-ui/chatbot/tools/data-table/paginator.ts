...
export class DataTablePaginator extends LitElement {
  ...
  @state()
  private isPreviousDisabled = true;

  @state()
  private isNextDisabled = false;

  protected willUpdate(): void {
    this.isPreviousDisabled = this.disabled || this.currentPage <= 1;
    this.isNextDisabled = this.disabled || this.currentPage >= this.totalPages;
  }
