 ...
 *
 * @cssproperty--ai-overlay-max-width - The maximum width of the overlay.
 * @cssproperty--ai-overlay-max-height - The maximum height of the overlay.
 * @cssproperty--ai-overlay-min-width - The minimum width of the overlay.
 * @cssproperty--ai-overlay-min-height - The minimum height of the overlay.
 *
