...
const meta = {
  ...
  argTypes: {
    ...
    customMessage: {
      ...
      if: { arg: "useCustomMessage", truthy: true },
    },
    useCustomIcon: {
      control: "boolean",
      description: "Use custom icon instead of default books icon",
    },
    iconType: {
      control: { type: "select" },
      options: ["star", "robot", "lightbulb", "heart"],
      description: "Type of custom icon to show",
      if: { arg: "useCustomIcon", truthy: true },
    },
  },
  args: {
    ...
    customMessage:
      "🤖 Welcome to our AI Assistant! I'm here to help you with any questions you might have.",
    useCustomIcon: false,
    iconType: "star",
  },
  render: (args: any) => {
    ...
    const getCustomIcon = (iconType: string) => {
      switch (iconType) {
        ...
        case "robot":
          return html`
            <svg slot="icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="graphic">
              <path fill="#4A90E2" d="M12 2c-1.1 0-2 .9-2 2v1H8c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V7c0-1.1-.9-2-2-2h-2V4c0-1.1-.9-2-2-2zM9 9c.6 0 1 .4 1 1s-.4 1-1 1-1-.4-1-1 .4-1 1-1zm6 0c.6 0 1 .4 1 1s-.4 1-1 1-1-.4-1-1 .4-1 1-1zm-3 4c1.7 0 3 1.3 3 3H9c0-1.7 1.3-3 3-3z"/>
            </svg>
          `;
        case "lightbulb":
          return html`
            <svg slot="icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="graphic">
              <path fill="#FFA500" d="M9 21c0 .5.4 1 1 1h4c.6 0 1-.5 1-1v-1H9v1zm3-19C8.1 2 5 5.1 5 9c0 2.4 1.2 4.5 3 5.7V17h8v-2.3c1.8-1.2 3-3.3 3-5.7 0-3.9-3.1-7-7-7z"/>
            </svg>
          `;
        case "heart":
          return html`
    ...
    return html`
      <forge-ai-empty-state .useCustomMessage=${args.useCustomMessage}>
        ${args.useCustomIcon ? getCustomIcon(args.iconType) : ""}
        ${args.useCustomMessage ? html`<p>${args.customMessage}</p>` : ""}
