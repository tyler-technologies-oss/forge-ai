...
import { DropdownMenuVariant } from '$lib/ai-dropdown-menu';
import { type DropdownMenuSelectionMode } from '$lib/ai-dropdown-menu/selection-manager';
...
const meta = {
  title: 'AI Components/Primitives/Dropdown Menu',
  component,
  argTypes: {
    variant: {
      control: 'select',
