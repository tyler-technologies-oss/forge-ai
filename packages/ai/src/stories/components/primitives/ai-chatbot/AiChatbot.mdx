...
The `header-actions` slot allows you to add custom action buttons to the chat header, positioned before the built-in header actions. This is useful for adding application-specific controls like history navigation, settings, or other contextual actions.

```html
<forge-ai-chatbot .adapter="${adapter}">
