...
Extend the `AiChatbotAdapterBase` class for custom protocols:

```typescript
import { AiChatbotAdapterBase, type ChatMessage, type FileAttachment } from '@tylertech/forge-ai';

class CustomAdapter extends AiChatbotAdapterBase {
